...
<head>
    ...
    <script type="text/javascript" src="https://ssl.pstatic.net/static.sports/resources/pc/8088/66/88/664600/js/generated/schedule.js" charset="UTF-8"></script>
...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/ehr/sportsxpress/volleyball_schedule.do" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.schedule', 'schedule', '', event); " aria-current="page">
...
<div class="tab_event">
    <ul class="list" id="_categoryList">
                ...
                <li class="selected"><a href="/volleyball/schedule/index" data-category="volleyball"><span class="menu">프로배구</span></a></li>
            
        
        
    </ul>
</div><div class="sch_volleyball"><div class="sch_volleyball">
            
                
                    
                    
                    
                        <script type="text/javascript" language="JavaScript">scoreBoardInstance = new ScoreBoardClass("kvolleyball", "");</script>
                        <div id="sch_recent_scoreboard" class="sch_game">
                            

    <div class="sch_score">
        <ul class="tab">
            <li class="btn_prev2"><a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230427');return false" title="이전">이전</a></li>
...
<form name="monthlyScheduleForm" id="monthlyScheduleForm" action="/schedule/index" method="get">
    <input type="hidden" name="uCategory" id="uCategory" value="kvolleyball">
...
<div class="date_select_nav type_year_month" style="display: block">
    ...
    <div class="select_box_area type_date">
       ...
       -->
        ...
        <button class="btn_move_date next" type="button" disabled="" onclick="clickcr(this, 'sch.nextmonth', '', '', event);changeSchedule('2023','06','');"><span class="blind">다음 달로 이동</span></button>
    </div>
