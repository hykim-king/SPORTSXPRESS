...
<head>
    ...
    <meta property="og:url" content="sports.news.naver.com/kbaseball/schedule/index?category=kbo">
    <title>일정/결과, 야구 : 네이버 스포츠</title>
    <!-- common css-->
...
#gnb.gnb_one_pwe .gnb_ico_num .gnb_count {border-radius: 0 13px 13px 0;}</style><script></script></head>
<body>
...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/ehr/sportsxpress/baseball_match.do" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.schedule', 'schedule', '', event); " aria-current="page">
...
<script>
    ...
    <div id="container">
        <div class="cms_side_banner type_kbaseball" id="_cms_side_banner">
        </div>
        <div id="content">
            
                <div class="sch_baseball">
                        ...
                        <h2 class="h_sch">KBO리그</h2>
                         
                            
                                <script></script>
                                <div id="sch_recent_scoreboard">
                                    

    <div class="sch_score">
        
        <ul role="tablist" class="tab">
            <li role="presentation" class="btn_prev2">
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230601', 'before');return false" title="이전" role="button">
        ...
        <div class="schedule_slider" id="_daily_schedule_root">
            ...
            <button type="button" class="button_prev" style="display: none; left: -52px; transition: all 300ms cubic-bezier(0.215, 0.61, 0.355, 1) 0s;">
                <span class="blind">이전</span>
                <span class="page">-511</span>
            </button>
            <button type="button" class="button_next" style="display: none; right: -52px; transition: all 300ms cubic-bezier(0.215, 0.61, 0.355, 1) 0s;">
                <span class="blind">다음</span>
...
<form name="monthlyScheduleForm" id="monthlyScheduleForm" action="/schedule/index" method="get">
    <input type="hidden" name="uCategory" id="uCategory" value="">
  <input type="hidden" name="category" id="category" value="kbo">
  <input type="hidden" name="year" id="year" value="2023">
  <input type="hidden" name="month" id="month" value="06">
  <input type="hidden" name="teamCode" id="teamCode" value="">
  <input type="hidden" name="date" id="date" value="20230609">
</form>

<div class="date_select_nav type_year_month" style="display: block">
  <span class="blind">종목별 경기 날짜 및 시즌 선택</span>
  
  <div class="select_box_area type_date">
    <div class="select_box">
      <!-- [D]
        ul.date_list 가 닫혀있다면 aria-expanded="false"
        ul.date_list 가 열려있다면 aria-expanded="true" 로 적용 해 주세요.
       -->
      <button class="btn_toggle" id="_currentYearButton" type="button" aria-haspopup="listbox" aria-expanded="false" aria-label="연도 선택" onclick="toggleYearList();">
      ...
      <ul class="option_list" role="listbox" id="_yearList">
        ...
        <!-- [D] 비활성회 되어야 하는 button.btn_date 에 disabled 속성을 추가 해 주세요. -->
          ...
          <li class="list" role="presentation" data-year="2023">
            <button class="btn_option" type="button" role="option" aria-selected="true" onclick="changeSchedule('2023','06','');">2023</button>
          </li>
        
          <li class="list" role="presentation" data-year="2022">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2022','06','');">2022</button>
          </li>
        
          <li class="list" role="presentation" data-year="2021">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2021','06','');">2021</button>
          </li>
        
          <li class="list" role="presentation" data-year="2020">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2020','06','');">2020</button>
          </li>
        
          <li class="list" role="presentation" data-year="2019">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2019','06','');">2019</button>
          </li>
        
          <li class="list" role="presentation" data-year="2018">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2018','06','');">2018</button>
          </li>
        
          <li class="list" role="presentation" data-year="2017">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2017','06','');">2017</button>
          </li>
        
          <li class="list" role="presentation" data-year="2016">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2016','06','');">2016</button>
          </li>
        
          <li class="list" role="presentation" data-year="2015">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2015','06','');">2015</button>
          </li>
        
          <li class="list" role="presentation" data-year="2014">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2014','06','');">2014</button>
          </li>
        
          <li class="list" role="presentation" data-year="2013">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2013','06','');">2013</button>
          </li>
        
          <li class="list" role="presentation" data-year="2012">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2012','06','');">2012</button>
          </li>
        
          <li class="list" role="presentation" data-year="2011">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2011','06','');">2011</button>
          </li>
        
          <li class="list" role="presentation" data-year="2010">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2010','06','');">2010</button>
          </li>
        
          <li class="list" role="presentation" data-year="2009">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2009','06','');">2009</button>
          </li>
        
          <li class="list" role="presentation" data-year="2008">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2008','06','');">2008</button>
          </li>
      ...
      <ul class="option_list" role="listbox" id="_monthList">
        ...
        <!-- [D] 비활성회 되어야 하는 button.btn_date 에 disabled 속성을 추가 해 주세요. -->
            ...
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','03','');">03</button>
            </li>
          
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','04','');">04</button>
            </li>
          
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','05','');">05</button>
            </li>
          
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" aria-selected="true" onclick="changeSchedule('2023','06','');">06</button>
            </li>
          
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','07','');">07</button>
            </li>
          
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','08','');">08</button>
            </li>
          
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','09','');">09</button>
            </li>
    ...
    <button class="btn_move_date prev" type="button" onclick="clickcr(this, 'sch.prevmonth', '', '', event);changeSchedule('2023','05','');"><span class="blind">이전 달로 이동</span></button>
    <button class="btn_move_date next" type="button" onclick="clickcr(this, 'sch.nextmonth', '', '', event);changeSchedule('2023','07','');"><span class="blind">다음 달로 이동</span></button>
  </div>
...
<div class="sch_tb_head">
  
  
  
  <p class="tl"><strong>2023시즌 경기일정</strong></p>
  <p class="tr"><a href="https://calendar.naver.com/subscribePage.nhn" target="_blank" onclick="clickcr(this, 'sch.feed', '', '', event);"><img src="https://imgnews.pstatic.net/image/sports/2013/baseball_schedule/btn_subs.gif" width="61" height="23" alt="구독하기"></a></p>
...
<div class="sch_tb_top">
  ...
  <caption>프로야구 경기일정</caption>
  <colgroup>
  <col width="88"><col width="55"><col><col><col><col width="55"><col width="221">
  </colgroup>
  <thead>
  <tr>
  <th scope="col"><span>날짜</span></th>
  <th scope="col"><span>시간</span></th>
  <th scope="col"><span>경기</span></th>
  <th scope="col"><span>중계/기록</span></th>
  <th scope="col"><span>중계방송사</span></th>
  <th scope="col"><span>구장</span></th>
  <th scope="col"><span>알림받기</span></th>
  </tr>
  </thead> 
  </table>
</div>
<div class="tb_wrap" id="calendarWrap">
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.1</strong> (목)</span>
      </td>
      ...
      <td class="add_state"><span class="team_lft">KT</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/KT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="KT" title="KT" onerror="imageOnError(this);"></span>
        ...
        <span class="emblem"><img width="25" height="25" alt="KIA" title="KIA" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HT.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
        <span class="team_rgt">KIA</span>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="롯데" title="롯데" onerror="imageOnError(this);"></span>
        
          
          
            <strong class="td_score">1<em>:</em>6</strong>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.3</strong> (토)</span>
      </td>
          
      <td><span class="td_hour">17:00</span></td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="KIA" title="KIA" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">5<em>:</em>6</strong>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230603HTLT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230603HTLT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/NC.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="NC" title="NC" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">7<em>:</em>3</strong>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230603NCLG02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230603NCLG02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/OB.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="두산" title="두산" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">3<em>:</em>13</strong>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230603OBKT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230603OBKT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SS.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="삼성" title="삼성" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">7<em>:</em>2</strong>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230603SSHH02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230603SSHH02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="키움" title="키움" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">1<em>:</em>2</strong>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230603WOSK02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230603WOSK02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.4</strong> (일)</span>
      </td>
          
      <td><span class="td_hour">14:00</span></td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="KIA" title="KIA" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">6<em>:</em>0</strong>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230604HTLT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230604HTLT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/NC.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="NC" title="NC" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">3<em>:</em>1</strong>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230604NCLG02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230604NCLG02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/OB.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="두산" title="두산" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">2<em>:</em>5</strong>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230604OBKT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230604OBKT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SS.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="삼성" title="삼성" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">5<em>:</em>10</strong>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230604SSHH02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230604SSHH02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="키움" title="키움" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">4<em>:</em>3</strong>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230604WOSK02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230604WOSK02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <div class="sch_tb nogame ">
      ...
      <tbody> 
      <tr>
      <td rowspan="1"><span class="td_date"><strong>6.5</strong> (월)</span></td>
      <td><span class="td_hour">-</span></td>
      <td><span class="td_none">프로야구 경기가 없습니다.</span></td>
      </tr>
      </tbody>
      </table>
    </div>    
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.6</strong> (화)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HH.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="한화" title="한화" onerror="imageOnError(this);"></span>
        
          
          
            <strong class="td_score">1<em>:</em>4</strong>
          
        
        <span class="emblem"><img width="25" height="25" alt="두산" title="두산" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/OB.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230606HHOB02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230606HHOB02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LG.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="LG" title="LG" onerror="imageOnError(this);"></span>
        
          
          
            <strong class="td_score">9<em>:</em>1</strong>
          
        
        <span class="emblem"><img width="25" height="25" alt="키움" title="키움" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230606LGWO02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230606LGWO02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SK.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="SSG" title="SSG" onerror="imageOnError(this);"></span>
        
          
          
            <strong class="td_score">2<em>:</em>1</strong>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230606SKHT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230606SKHT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/KT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="KT" title="KT" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">4<em>:</em>1</strong>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230606KTLT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230606KTLT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/NC.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="NC" title="NC" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">6<em>:</em>9</strong>
          
        
        <span class="emblem"><img width="25" height="25" alt="삼성" title="삼성" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SS.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230606NCSS02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230606NCSS02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
          ...
          <span class="td_stadium">
                ...
                KBS N SPORTS, MBC SPORTS+<br>SPOTV
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.7</strong> (수)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HH.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="한화" title="한화" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">3<em>:</em>6</strong>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230607HHOB02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230607HHOB02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/KT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="KT" title="KT" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">3<em>:</em>2</strong>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230607KTLT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230607KTLT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LG.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="LG" title="LG" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">5<em>:</em>5</strong>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230607LGWO02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230607LGWO02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/NC.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="NC" title="NC" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">4<em>:</em>0</strong>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230607NCSS02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230607NCSS02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SK.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="SSG" title="SSG" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">9<em>:</em>8</strong>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230607SKHT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230607SKHT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.8</strong> (목)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230608HHOB02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230608HHOB02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/KT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="KT" title="KT" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">7<em>:</em>6</strong>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230608KTLT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230608KTLT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LG.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="LG" title="LG" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">0<em>:</em>13</strong>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230608LGWO02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230608LGWO02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/NC.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="NC" title="NC" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">7<em>:</em>1</strong>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230608NCSS02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230608NCSS02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SK.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="SSG" title="SSG" onerror="imageOnError(this);"></span>
            ...
            <strong class="td_score">5<em>:</em>4</strong>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230608SKHT02023/record" onclick="clickcr(this, 'sch.gamerecord', '', '', event);"><img width="61" height="23" alt="경기결과" src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_result2.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                  ...
                  <a href="/game/20230608SKHT02023/video" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_vod2.gif"></a>
  ...
  <div class="sch_tb selected">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.9</strong> (금)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230609HTOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                ...
                <img width="61" height="23" alt="TV중계" src="https://imgnews.pstatic.net/image/sports/2010/kbo_schedule/btn_tv2_off.gif">
      ...
      <td>
        <span class="td_stadium" id="stadiumWeather0">잠실</span>
        <script ></script>       
      </td>
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-09 18:30:00.0', '프로야구 | KIA vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230609LGHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        <span class="td_stadium" id="stadiumWeather1">대전</span>
        <script></script>       
      </td>
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-09 18:30:00.0', '프로야구 | LG vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230609LTSS02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        <span class="td_stadium" id="stadiumWeather2">대구</span>
        <script ></script>       
      </td>
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-09 18:30:00.0', '프로야구 | 롯데 vs 삼성', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230609SKNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        <span class="td_stadium" id="stadiumWeather3">창원</span>
        <script ></script>       
      </td>
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-09 18:30:00.0', '프로야구 | SSG vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230609WOKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        <span class="td_stadium" id="stadiumWeather4">수원</span>
        <script ></script>       
      </td>
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-09 18:30:00.0', '프로야구 | 키움 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.10</strong> (토)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230610HTOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-10 17:00:00.0', '프로야구 | KIA vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230610LGHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-10 17:00:00.0', '프로야구 | LG vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230610LTSS02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-10 17:00:00.0', '프로야구 | 롯데 vs 삼성', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230610SKNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-10 17:00:00.0', '프로야구 | SSG vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230610WOKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-10 17:00:00.0', '프로야구 | 키움 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.11</strong> (일)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230611HTOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-11 17:00:00.0', '프로야구 | KIA vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230611LGHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-11 17:00:00.0', '프로야구 | LG vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230611LTSS02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-11 17:00:00.0', '프로야구 | 롯데 vs 삼성', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230611SKNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-11 17:00:00.0', '프로야구 | SSG vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230611WOKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-11 17:00:00.0', '프로야구 | 키움 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <div class="sch_tb2 nogame2 ">
      ...
      <tbody> 
      <tr>
      <td rowspan="1"><span class="td_date"><strong>6.12</strong> (월)</span></td>
      <td><span class="td_hour">-</span></td>
      <td><span class="td_none">프로야구 경기가 없습니다.</span></td>
      </tr>
      </tbody>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.13</strong> (화)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230613HHLT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
            ...
            <!-- 우측 버튼 [중계(N) 중계(Y) 영상] -->
                ...
                <img width="61" height="23" alt="문자중계" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_wd2_off.gif">
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-13 18:30:00.0', '프로야구 | 한화 vs 롯데', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230613HTWO02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-13 18:30:00.0', '프로야구 | KIA vs 키움', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230613KTSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-13 18:30:00.0', '프로야구 | KT vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230613OBNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-13 18:30:00.0', '프로야구 | 두산 vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230613SSLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-13 18:30:00.0', '프로야구 | 삼성 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.14</strong> (수)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230614HHLT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-14 18:30:00.0', '프로야구 | 한화 vs 롯데', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230614HTWO02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-14 18:30:00.0', '프로야구 | KIA vs 키움', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230614KTSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-14 18:30:00.0', '프로야구 | KT vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230614OBNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-14 18:30:00.0', '프로야구 | 두산 vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230614SSLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-14 18:30:00.0', '프로야구 | 삼성 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.15</strong> (목)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230615HHLT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-15 18:30:00.0', '프로야구 | 한화 vs 롯데', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230615HTWO02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-15 18:30:00.0', '프로야구 | KIA vs 키움', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230615KTSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-15 18:30:00.0', '프로야구 | KT vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230615OBNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-15 18:30:00.0', '프로야구 | 두산 vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230615SSLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-15 18:30:00.0', '프로야구 | 삼성 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.16</strong> (금)</span>
      </td>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230616LTSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-16 18:30:00.0', '프로야구 | 롯데 vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230616NCHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-16 18:30:00.0', '프로야구 | NC vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230616OBLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-16 18:30:00.0', '프로야구 | 두산 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230616SSKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-16 18:30:00.0', '프로야구 | 삼성 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230616WOHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-16 18:30:00.0', '프로야구 | 키움 vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.17</strong> (토)</span>
      </td>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230617LTSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-17 17:00:00.0', '프로야구 | 롯데 vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230617NCHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-17 17:00:00.0', '프로야구 | NC vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230617OBLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-17 17:00:00.0', '프로야구 | 두산 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230617SSKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-17 17:00:00.0', '프로야구 | 삼성 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230617WOHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-17 17:00:00.0', '프로야구 | 키움 vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.18</strong> (일)</span>
      </td>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230618LTSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-18 17:00:00.0', '프로야구 | 롯데 vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230618NCHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-18 17:00:00.0', '프로야구 | NC vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230618OBLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-18 17:00:00.0', '프로야구 | 두산 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230618SSKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-18 17:00:00.0', '프로야구 | 삼성 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230618WOHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-18 17:00:00.0', '프로야구 | 키움 vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <div class="sch_tb nogame ">
      ...
      <tbody> 
      <tr>
      <td rowspan="1"><span class="td_date"><strong>6.19</strong> (월)</span></td>
      <td><span class="td_hour">-</span></td>
      <td><span class="td_none">프로야구 경기가 없습니다.</span></td>
      </tr>
      </tbody>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.20</strong> (화)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230620HTHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-20 18:30:00.0', '프로야구 | KIA vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230620LGNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-20 18:30:00.0', '프로야구 | LG vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230620LTKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-20 18:30:00.0', '프로야구 | 롯데 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230620SKOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-20 18:30:00.0', '프로야구 | SSG vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230620WOSS02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-20 18:30:00.0', '프로야구 | 키움 vs 삼성', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.21</strong> (수)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230621HTHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-21 18:30:00.0', '프로야구 | KIA vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230621LGNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-21 18:30:00.0', '프로야구 | LG vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230621LTKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-21 18:30:00.0', '프로야구 | 롯데 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230621SKOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-21 18:30:00.0', '프로야구 | SSG vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230621WOSS02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-21 18:30:00.0', '프로야구 | 키움 vs 삼성', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.22</strong> (목)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230622HTHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-22 18:30:00.0', '프로야구 | KIA vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230622LGNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-22 18:30:00.0', '프로야구 | LG vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230622LTKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-22 18:30:00.0', '프로야구 | 롯데 vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230622SKOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-22 18:30:00.0', '프로야구 | SSG vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230622WOSS02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-22 18:30:00.0', '프로야구 | 키움 vs 삼성', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.23</strong> (금)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230623HHNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-23 18:30:00.0', '프로야구 | 한화 vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230623KTHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-23 18:30:00.0', '프로야구 | KT vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230623LTLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-23 18:30:00.0', '프로야구 | 롯데 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230623OBWO02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-23 18:30:00.0', '프로야구 | 두산 vs 키움', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230623SSSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-23 18:30:00.0', '프로야구 | 삼성 vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.24</strong> (토)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230624HHNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-24 17:00:00.0', '프로야구 | 한화 vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230624KTHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-24 17:00:00.0', '프로야구 | KT vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230624LTLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-24 17:00:00.0', '프로야구 | 롯데 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230624OBWO02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-24 17:00:00.0', '프로야구 | 두산 vs 키움', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230624SSSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-24 17:00:00.0', '프로야구 | 삼성 vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.25</strong> (일)</span>
      </td>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230625OBWO02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-25 14:00:00.0', '프로야구 | 두산 vs 키움', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">NC</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230625HHNC02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-25 17:00:00.0', '프로야구 | 한화 vs NC', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230625KTHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-25 17:00:00.0', '프로야구 | KT vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">롯데</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230625LTLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-25 17:00:00.0', '프로야구 | 롯데 vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230625SSSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-25 17:00:00.0', '프로야구 | 삼성 vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <div class="sch_tb2 nogame2 ">
      ...
      <tbody> 
      <tr>
      <td rowspan="1"><span class="td_date"><strong>6.26</strong> (월)</span></td>
      <td><span class="td_hour">-</span></td>
      <td><span class="td_none">프로야구 경기가 없습니다.</span></td>
      </tr>
      </tbody>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.27</strong> (화)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230627KTHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-27 18:30:00.0', '프로야구 | KT vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230627LGSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-27 18:30:00.0', '프로야구 | LG vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230627NCOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-27 18:30:00.0', '프로야구 | NC vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230627SSLT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-27 18:30:00.0', '프로야구 | 삼성 vs 롯데', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230627WOHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-27 18:30:00.0', '프로야구 | 키움 vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.28</strong> (수)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230628KTHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-28 18:30:00.0', '프로야구 | KT vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230628LGSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-28 18:30:00.0', '프로야구 | LG vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230628NCOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-28 18:30:00.0', '프로야구 | NC vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230628SSLT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-28 18:30:00.0', '프로야구 | 삼성 vs 롯데', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230628WOHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-28 18:30:00.0', '프로야구 | 키움 vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.29</strong> (목)</span>
      </td>
      ...
      <td class=""><span class="team_lft">KT</span>
        ...
        <span class="team_rgt">한화</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230629KTHH02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-29 18:30:00.0', '프로야구 | KT vs 한화', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">LG</span>
        ...
        <span class="team_rgt">SSG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230629LGSK02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-29 18:30:00.0', '프로야구 | LG vs SSG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        ...
        <span class="team_rgt">두산</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230629NCOB02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-29 18:30:00.0', '프로야구 | NC vs 두산', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">삼성</span>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230629SSLT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-29 18:30:00.0', '프로야구 | 삼성 vs 롯데', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">키움</span>
        ...
        <span class="team_rgt">KIA</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230629WOHT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-29 18:30:00.0', '프로야구 | 키움 vs KIA', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
  ...
  <div class="sch_tb2 ">
    ...
    <tr>
      ...
      <td rowspan="5">
        <span class="td_date"><strong>6.30</strong> (금)</span>
      </td>
      ...
      <td class=""><span class="team_lft">한화</span>
        ...
        <span class="team_rgt">삼성</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230630HHSS02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-30 18:30:00.0', '프로야구 | 한화 vs 삼성', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">KIA</span>
        ...
        <span class="team_rgt">LG</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230630HTLG02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-30 18:30:00.0', '프로야구 | KIA vs LG', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">NC</span>
        ...
        <span class="team_rgt">KT</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230630NCKT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-30 18:30:00.0', '프로야구 | NC vs KT', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">두산</span>
        ...
        <span class="team_rgt">롯데</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230630OBLT02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-30 18:30:00.0', '프로야구 | 두산 vs 롯데', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
    ...
    <tr>
      ...
      <td class=""><span class="team_lft">SSG</span>
        ...
        <span class="team_rgt">키움</span>
            ...
            <!-- 좌측 버튼 [전력 영상(Y/N) 결과] -->
                ...
                <a href="/game/20230630SKWO02023/preview" onclick="clickcr(this, 'sch.gamepreview', '', '', event);"><img width="61" height="23" alt="전력" src="https://ssl.pstatic.net/static/sports/2021/pc/04/08/btn_power.gif"></a>
      ...
      <td>
        ...
        <div>
          <a href="#" target="_blank" onclick="nhn.calendarScrap.scrap(null, getScrapData('2023-06-30 18:30:00.0', '프로야구 | SSG vs 키움', ''), this.offsetParent.offsetLeft - nhn.calendarScrap._width + 61, this.offsetParent.offsetTop + this.offsetParent.offsetParent.offsetParent.offsetTop + 23);clickcr(this, 'sch.smsnoti', '', '', event);return false;">
          <img src="https://imgnews.pstatic.net/image/sports/2011/baseball_schedule/btn_alarm.gif" width="61" height="23" alt="알림"></a>
        </div>
...
<tbody><tr><td width="120" bgcolor=""></td>
  <td valign="bottom" align="right" style="padding:20px 12px 20px 0">
  <img width="15" height="15" src="https://imgsports.pstatic.net/images/common/sub_home.gif">
  <a class="gray20 p11 ls1 vl" href="/kbaseball/index">야구 홈으로</a>&nbsp;&nbsp;
  <img width="15" height="15" src="https://imgsports.pstatic.net/images/common/sub_top.gif">
  <a onclick="topPage();" class="gray20 p11 ls1 vl" href="#top">맨 위로</a></td>
</tr></tbody></table>
            ...
            <div class="gamedata_info">
                ...
                네이버(주)는 그에 따른 스포츠 데이터의 정확성 및 신뢰성을 담보하지 않습니다. 궁금하신 사항은 <a href="https://help.naver.com/support/alias/contents2/sports/sports_5.naver" target="_blank">고객센터</a>를 통해서 문의해주시기 바랍니다.
            </div>
