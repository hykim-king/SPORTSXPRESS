...
<meta property="og:url"
	content="sports.news.naver.com/basketball/record/index?category=kbl&amp;tab=team">
					...
					<div class="gnb_one" id="gnb">
						...
						<ul class="gnb_lst" id="gnb_lst" style="display: block;">
							<li class="gnb_login_li" id="gnb_login_layer"
								...
								href="https://nid.naver.com/nidlogin.login?url=https%3A%2F%2Fsports.naver.com%2Fbasketball%2Frecord%2Findex%3Fcategory%3Dkbl"
										...
										<div class="gnb_txt_area">
											<p class="gnb_account">
												<span class="gnb_name" id="gnb_name2"><a
													...
													class="gnb_btn_login"
													href="https://nid.naver.com/nidlogin.logout?returl=https%3A%2F%2Fsports.naver.com%2Fbasketball%2Frecord%2Findex%3Fcategory%3Dkbl"
			...
			<div id="content">
				...
				<div class="tab_event">
					<ul class="list" id="_categoryList">
						<li class="selected"><a
							href="/basketball/record/index?category=kbl" data-category="kbl"><span
       ...
       -->
										...
										<button class="btn_toggle" type="button"
											...
											<em class="now_selected"><span class="blind">선택된
													시즌</span>2022<span class="dash">-</span>23</em>
										</button>
										...
										<ul class="option_list" role="listbox" id="_yearList">
											...
											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="true">2022-23</button>
											</li>
							...
							<table cellspacing="0" cellpadding="0">
								...
								<thead>
									<tr>
										...
										<th><div class="wnrt">
												<strong id="regularTeamRecordList_winRate" class="sort"><span
													class="blind">승률</span></strong></a>
											</div></th>
										<th><div class="wpnt">
												<strong id="regularTeamRecordList_win"><span
													class="blind">승</span></strong></a>
											</div></th>
										<th><div class="lpnt">
												<strong id="regularTeamRecordList_lose"><span
													class="blind">패</span></strong></a>
											</div></th>
										<th><div class="score">
												<strong id="regularTeamRecordList_scoreAvg"><span
													class="blind">득점</span></strong></a>
											</div></th>
									</tr>
								</thead>
								<tbody id="regularTeamRecordList_table">
									<c:forEach var="records" items="${records}" varStatus="loop">
										...
										<td class="tm">
											<div>
												<span class="emblem"><img src="${records.logo}"
													width="25" height="25" alt="구단로고"
													onerror="imageOnError(this);"></span> <span id="team_70">${records.tname}</span>
											</div>
										</td>
						...
						<div class="tit_box">
							<h4 class="h_head_player">
								<span class="blind">주요 부문 선두</span>
							</h4>
						</div>

						<div class="tbl_box p_head">
							<table cellspacing="0" cellpadding="0">
								<caption>득점, 도움, 리바운드, 3점슛 부문 선두 테이블</caption>
								<thead>
									<tr>
										<th><div class="">
												<strong class="title">득점 평균</strong>
											</div></th>
										<th><div class="">
												<strong class="title">도움 평균</strong>
											</div></th>
										<th><div class="">
												<strong class="title">리바운드 평균</strong>
											</div></th>
										<th><div class="">
												<strong class="title">3점슛 성공</strong>
											</div></th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<c:forEach var="bestplayers" items="${bestPlayers}"
											varStatus="loop">
											<td>
												<div class="ph">
													<span class="image"> <img width="63" height="88"
														src="${bestplayers.profile}"
														onerror="javaScript:noImg(this);"> <span
														class="mask"></span>
													</span>
													<p class="ph_info">
							...
							<table cellspacing="0" cellpadding="0">
								...
								<thead>
									<tr>
										...
										<th><div class="gcnt_s">
												<a href="javaScript:sortByPlayerColumn('gameCount');"><strong
													id="player_gameCount"><span class="blind">경기수</span></strong></a>
											</div></th>
										<th><div class="score">
												<a href="javaScript:sortByPlayerColumn('point');"><strong
													id="player_point" class="sort"><span class="blind">득점</span></strong></a>
											</div></th>
										<th><div class="as">
												<a href="javaScript:sortByPlayerColumn('assist');"><strong
													id="player_assist"><span class="blind">AS</span></strong></a>
											</div></th>
										<th><div class="rbd">
												<a href="javaScript:sortByPlayerColumn('rebound');"><strong
													id="player_rebound"><span class="blind">리바운드</span></strong></a>
											</div></th>
										<th><div class="stl">
												<a href="javaScript:sortByPlayerColumn('steal');"><strong
													id="player_steal"><span class="blind">스틸</span></strong></a>
											</div></th>
										<th><div class="block">
												<a href="javaScript:sortByPlayerColumn('block');"><strong
													id="player_block"><span class="blind">블록</span></strong></a>
											</div></th>
										<th><div class="sht_2">
												<a href="javaScript:sortByPlayerColumn('point2');"><strong
													id="player_point2"><span class="blind">2점슛</span></strong></a>
											</div></th>
										<th><div class="sht_3">
												<a href="javaScript:sortByPlayerColumn('point3');"><strong
													id="player_point3"><span class="blind">3점슛</span></strong></a>
											</div></th>
										<th><div class="sht_f">
												<a href="javaScript:sortByPlayerColumn('freeThrow');"><strong
													id="player_freeThrow"><span class="blind">자유투</span></strong></a>
											</div></th>
										<th><div class="sht_2ss">
												<a href="javaScript:sortByPlayerColumn('point2Rate');"><strong
													id="player_point2Rate"><span class="blind">2점슛성공</span></strong></a>
											</div></th>
										<th><div class="sht_3ss">
												<a href="javaScript:sortByPlayerColumn('point3Rate');"><strong
													id="player_point3Rate"><span class="blind">3점슛성공</span></strong></a>
											</div></th>
										<th><div class="sht_fss">
												<a href="javaScript:sortByPlayerColumn('freeThrowRate');"><strong
													id="player_freeThrowRate"><span class="blind">자유투성</span></strong></a>
											</div></th>
									</tr>
								</thead>
										...
										<td class="ply">
											<div>
												<span class="emblem"><img width="25" height="25"
													src="${players.profile}" alt="구단 로고"
													onerror="imageOnError(this);"></span> <span>${players.name}</span>
											</div>
										</td>
					...
					<div class="record_info">
						...
						<ul class="p_noti">
							...
							<li>※ 농구 순위는 시즌 종료 시 전년도 순위 기준으로 노출되며, 개막일 이후 새 시즌 순위표로
								노출됩니다.</li>
