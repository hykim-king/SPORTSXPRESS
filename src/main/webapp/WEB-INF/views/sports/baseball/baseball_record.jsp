...
<link rel="stylesheet" type="text/css"
	href="https://ssl.pstatic.net/static.sports/resources/pc/8088/66/88/664600/css/baseball_gamecenter.css">
	...
	<div id="wrap">
										...
										<div class="gnb_txt_area">
											<p class="gnb_account">
												<span class="gnb_name" id="gnb_name2"><a
													class="gnb_nick"
													href="https://nid.naver.com/user2/api/naverProfile?m=checkIdType">_</a>님</span>
											</p>
			...
			<nav class="sports_lnb_sub">
				<ul id="lnb_sub_list" class="lnb_sub_list" role="menubar">
					...
					<li class="lnb_sub_item " role="presentation"><a
						href="/ehr/sportsxpress/baseball_news.do" class="link_lnb_sub"
						role="menuitem"
						onclick="clickcr(this, 'LNB.news', 'news', '', event); "> <span
							class="menu">최신뉴스</span>
					</a></li>
					<li class="lnb_sub_item " role="presentation"><a
						href="/ehr/sportsxpress/baseball_schedule.do"
					...
					<li class="lnb_sub_item " role="presentation"><a
						...
						aria-current="page"> <span class="menu">기록/순위</span>
					</a></li>
       ...
       -->
										<button class="btn_toggle" type="button"
											...
											aria-label="시즌 선택" id="_currentYearButton"
											onclick="toggleYearList();">
											<em class="now_selected"><span class="blind">선택된
													시즌</span>2023</em>
										</button>
										...
										<ul class="option_list" role="listbox" id="_yearList">
											...
											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="true"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2023'">2023</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2022'">2022</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2021'">2021</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2020'">2020</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2019'">2019</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2018'">2018</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2017'">2017</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2016'">2016</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2015'">2015</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2014'">2014</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2013'">2013</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2012'">2012</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2011'">2011</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2010'">2010</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2009'">2009</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2008'">2008</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2007'">2007</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2006'">2006</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2005'">2005</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2004'">2004</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2003'">2003</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2002'">2002</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2001'">2001</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2000'">2000</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1999'">1999</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1998'">1998</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1997'">1997</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1996'">1996</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1995'">1995</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1994'">1994</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1993'">1993</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1992'">1992</button>
											</li>

											<li class="list" role="presentation">
												<button class="btn_option" type="button" role="option"
													aria-selected="false"
													onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1991'">1991</button>
											</li>
									...
									<button class="btn_move_date prev" type="button">
								...
								<thead>
									<tr>
										...
										<th>
											<div class="gcnt_s">
												<a
													href="javascript:sortByColumn('regularTeamRecordList','gameCount');">
													<strong id="regularTeamRecordList_gameCount"><span
														class="blind">경기수</span></strong>
												</a>
											</div>
										</th>
										<th>
											<div class="wpnt">
												<a
													href="javascript:sortByColumn('regularTeamRecordList','won');">
													<!-- [D]정렬기능 on,off시 sort클래스 추가, 선택된 카테고리 활성화 강조 테두리는 table종료 태그 밑에 추가하였음. -->
													<strong id="regularTeamRecordList_won"><span
														class="blind">승</span></strong>
												</a>
											</div>
										</th>
										<th>
											<div class="lpnt">
												<a
													href="javascript:sortByColumn('regularTeamRecordList','lost');">
													<strong id="regularTeamRecordList_lost"><span
														class="blind">패</span></strong>
												</a>
											</div>
										</th>
										<th>
											<div class="dpnt">
												<a
													href="javascript:sortByColumn('regularTeamRecordList','drawn');">
													<strong id="regularTeamRecordList_drawn"><span
														class="blind">무</span></strong>
												</a>
											</div>
										</th>
										<th>
											<div class="wnrt">
												<a
													href="javascript:sortByColumn('regularTeamRecordList','wra');">
													<strong class="sort"><span
														id="regularTeamRecordList_wra" class="blind">승률</span></strong>
												</a>
											</div>
										</th>
									</tr>
								...
								<tbody id="regularTeamRecordList_table">
									<c:forEach var="record" items="${records}" varStatus="loop">
										<tr>
											...
											<td class="tm">
												<div>
													<span class="emblem"><img src="${record.logo}"
														width="25" height="25" alt="구단로고"
														onerror="imageOnError(this);"></span> <span>${record.tname}</span>
												</div>
											</td>
						...
						<div class="tit_box2">
							<div class="tab_event">
								<ul class="list" id="_playerTypeList">
									<li class="selected" data-player-type-id="pitcher"><a
										href="#"><span class="menu">투수 순위<span
												class="blind">선택됨</span></span></a></li>
								</ul>
							</div>
						</div>
						...
						<div id="_pitcherRecord"
							class="tbl_box pitcher tbl_paging _playerRecordDiv">
							...
							<table cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<th>
											<div class="era" data-stats-code="era">
												<a href="#"> <strong class="sort"><span
														class="blind">평균자책점</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="gcnt_s" data-stats-code="game_count">
												<a href="#"> <strong><span class="blind">경기수</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="inning" data-stats-code="inn">
												<a href="#"> <strong><span class="blind">이닝</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="wpnt" data-stats-code="w">
												<a href="#"> <strong><span class="blind">승</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="lpnt" data-stats-code="l">
												<a href="#"> <strong><span class="blind">패</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="save" data-stats-code="sv">
												<a href="#"> <strong><span class="blind">세이브</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="hold" data-stats-code="hold">
												<a href="#"> <strong><span class="blind">홀드</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="strikeout" data-stats-code="kk">
												<a href="#"> <strong><span class="blind">삼진</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="hitball" data-stats-code="hit">
												<a href="#"> <strong><span class="blind">피안타</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="homerunball" data-stats-code="hr">
												<a href="#"> <strong><span class="blind">피홈런</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="losepoint" data-stats-code="r">
												<a href="#"> <strong><span class="blind">실점</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="fourball" data-stats-code="bb">
												<a href="#"> <strong><span class="blind">볼넷</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="deadball" data-stats-code="hp">
												<a href="#"> <strong><span class="blind">사구</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="wnrt" data-stats-code="winp">
												<a href="#"> <strong><span class="blind">승률</span></strong>
												</a>
											</div>
										</th>
									</tr>
								...
								<tbody>
									<c:forEach var="tusus" items="${tusus}" varStatus="loop">
										...
										<td class="ply">
											<div>
												<span class="emblem"><img width="25" height="25"
													src="${tusus.logo}" alt="구단 로고"
													onerror="imageOnError(this);"></span> <span>${tusus.name}</span>
											</div>
										</td>
										<td><span>${tusus.eravg}</span></td>
										<td><span>${tusus.played}</span></td>
										<td><span>${tusus.inning}</span></td>
										<td><span>${tusus.win}</span></td>
										<td><span>${tusus.lose}</span></td>
										<td><span>${tusus.save}</span></td>
										<td><span>${tusus.hold}</span></td>
										<td><span>${tusus.k}</span></td>
										<td><span>${tusus.ob}</span></td>
										<td><span>${tusus.ohr}</span></td>
										<td><span>${tusus.r}</span></td>
										<td><span>${tusus.ball4}</span></td>
										<td><span>${tusus.bb}</span></td>
										<td><span>${tusus.wper}</span></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
						...
						<div class="tit_box2">
							<div class="tab_event">
								<ul class="list" id="_playerTypeList">
									<li class="selected" data-player-type-id="pitcher"><a
										href="#"><span class="menu">타자 순위<span
												class="blind">선택됨</span></span></a></li>
								</ul>
							</div>
						</div>
						...
						<div id="_batterRecord"
							class="tbl_box hitter tbl_paging _playerRecordDiv">
									...
									<tr>
										...
										<th>
											<div class="batavg" data-stats-code="hra">
												<a href="#"> <strong><span class="blind">타율</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="atbat" data-stats-code="ab">
												<a href="#"> <strong><span class="blind">타수</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="hit" data-stats-code="hit">
												<a href="#"> <strong><span class="blind">안타</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="twobasehit" data-stats-code="h2">
												<a href="#"> <strong><span class="blind">2루타</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="threebasehit" data-stats-code="h3">
												<a href="#"> <strong><span class="blind">3루타</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="homerun" data-stats-code="hr">
												<a href="#"> <strong><span class="blind">홈런</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="rbi" data-stats-code="rbi">
												<a href="#"> <strong><span class="blind">타점</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="score" data-stats-code="run">
												<a href="#"> <strong><span class="blind">득점</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="steal" data-stats-code="sb">
												<a href="#"> <strong><span class="blind">도루</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="onbase" data-stats-code="obp">
												<a href="#"> <strong><span class="blind">출루율</span></strong>
												</a>
											</div>
										</th>
										...
										<th>
											<div class="slugging" data-stats-code="slg">
												<a href="#"> <strong><span class="blind">장타율</span></strong>
												</a>
											</div>
										</th>
								...
								<tbody>
									<c:forEach var="tajas" items="${tajas}" varStatus="loop">
										...
										<td class="ply">
											<div>
												<span class="emblem"><img width="25" height="25"
													src="${tajas.logo}" alt="구단 로고"
													onerror="imageOnError(this);"></span> <span>${tajas.name}</span>
											</div>
										</td>
										<td><span>${tajas.avg}</span></td>
										<td><span>${tajas.played}</span></td>
										<td><span>${tajas.hits}</span></td>
										<td><span>${tajas.safety}</span></td>
										<td><span>${tajas.b2}</span></td>
										<td><span>${tajas.b3}</span></td>
										<td><span>${tajas.hr}</span></td>
										<td><span>${tajas.rbi}</span></td>
										<td><span>${tajas.score}</span></td>
										<td><span>${tajas.steal}</span></td>
										<td><span>${tajas.ball4}</span></td>
										<td><span>${tajas.k}</span></td>
										<td><span>${tajas.obp}</span></td>
										<td><span>${tajas.slg}</span></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
				...
				<div class="record_info">
					...
					<ul class="p_noti">
						...
						<li>※ 야구 순위는 시즌 종료 시 전년도 순위 기준으로 노출되며, 개막일 이후 새 시즌 순위표로
							노출됩니다.</li>
					...
					<p class="p_desc">
						...
						사항은 <a
							href="https://help.naver.com/alias/contents2/sports/sports_27.naver"
		...
		<div id="footer">
			<div class="inner">
				<div class="page_area">
					...
					<div class="sports_league">
						<ul class="league_list">
							...
							<li class="league_item"><a
								href="/ehr/sportsxpress/baseball/baseball_news.do"
								class="link_league">야구</a></li>
							<li class="league_item"><a
								href="/ehr/sportsxpress/football/football_news.do"
								class="link_league">축구</a></li>
							<li class="league_item"><a
								href="/ehr/sportsxpress/basketball/basketball_news.do"
								class="link_league">농구</a></li>
							<li class="league_item"><a
								href="/ehr/sportsxpress/volleyball/volleyball_news.do"
								class="link_league">배구</a></li>
							<li class="league_item"><a
								href="/ehr/sportsxpress/golf/golf_news.do" class="link_league">골프</a></li>
						</ul>
					</div>
				</div>
				<div class="sports_info">
					...
					<p class="footer_copyright">본 콘텐츠의 저작권은 민윤홍 또는 네이버에 있으며, 이를 무단
