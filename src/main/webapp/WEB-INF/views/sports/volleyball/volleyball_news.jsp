                    ...
                    <div class="tool_area">
                        <div class="gnb_one" id="gnb">
                            ...
                            <ul class="gnb_lst" id="gnb_lst" style="display: block;">
                                <li class="gnb_login_li" id="gnb_login_layer" style="display: none;">
                                    <a class="gnb_btn_login" href="https://nid.naver.com/nidlogin.login?url=https%3A%2F%2Fsports.news.naver.com%2Fvolleyball%2Fnews%2Findex" id="gnb_login_button">
                                ...
                                <li class="gnb_my_li" id="gnb_my_layer" style="display: inline-block;">
                                    <div class="gnb_my_namebox" id="gnb_my_namebox" style="background-image: url('https://ssl.pstatic.net/static/common/gnb/2014/ico_arrow_wh.gif');">
                                        <a href="javascript:;" id="gnb_my" class="gnb_my" onclick="gnbUserLayer.clickToggle(); return false;">
                                            ...
                                            />
                                            <span id="gnb_profile_filter_mask" class="filter_mask" style="display: inline-block;"></span> <span class="gnb_name" id="gnb_name1">플르토</span><em class="blind">내정보 보기</em>
                                    ...
                                    <div class="gnb_my_lyr" id="gnb_my_lyr">
                                        <div class="gnb_my_content">
                                            ...
                                            <div class="gnb_txt_area">
                                                <p class="gnb_account">
                                                    <span class="gnb_name" id="gnb_name2"><a class="gnb_nick" href="https://nid.naver.com/user2/api/naverProfile?m=checkIdType">플르토</a>님</span>
                                                    <a class="gnb_btn_login" href="https://nid.naver.com/nidlogin.logout?returl=https%3A%2F%2Fsports.news.naver.com%2Fvolleyball%2Fnews%2Findex" id="gnb_logout_button">
                                        ...
                                        <div class="gnb_my_community">
                                            ...
                                            <a href="https://pay.naver.com" class="gnb_pay" id="gnb_pay_banner_membership" style="display: none;"><span>N Pay</span></a>
                                            <a href="https://nid.naver.com/membership/join" class="gnb_pay" id="gnb_pay_banner_newbie" style="display: block;"><i>네이버 멤버십 최대 5% 적립</i></a>
                                        </div>
                                ...
                                <li class="gnb_notice_li" id="gnb_notice_layer" style="display: inline-block;">
                                    <a href="javascript:;" class="gnb_notice" onclick="gnbNaverMeLayer.clickToggle(); return false;">
                                        ...
                                        <em class="gnb_ico_num" id="gnb_me_menu" style="display: block;">
                                            <span class="gnb_ico_new">
                                                <span class="gnb_count" id="gnb_me_count" style="display: inline-block;">99<span class="plus">+</span></span>
                                            </span>
                                        </em>
                                        <span class="ico_arrow"></span>
                                    </a>
                                ...
                                <li class="mail_li" id="gnb_mail_layer" style="display: inline-block;">
                                    <a href="https://mail.naver.com" class="gnb_mail">
                                        ...
                                        <em class="gnb_ico_num" id="gnb_mail_menu" style="display: block;">
                                            <span class="gnb_ico_new">
                                                <span class="gnb_count" id="gnb_mail_count" style="display: inline-block;">99<span class="plus">+</span></span>
                                            </span>
                                        </em>
                                    </a>
                                </li>
                            ...
                            <div class="content_area">
                                <div class="tab_event">
                                    <ul class="list" id="_sectionList">
                                        <li class="selected" data-id="volleyball">
                                            <a href="#" onclick="clickcr(this, 'nwl.league', '', '', event);"><span class="menu">프로배구 전체</span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="news_lnb">
                                    ...
                                    <ul class="aside_vod_list2">
                                            ...
                                            <a href="${videos[0].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    ...
                                                    <img
                                                        ...
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230619_299/18idT_1687171215868eNr0C_JPEG/356086d3-0e8d-11ee-b270-a0369ffdad70_03.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[1].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">2</b> <span class="time"><span class="blind">재생시간</span>00:31</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230619_275/vx2N7_16871708394633Ea8I_JPEG/8cc0001b-0e8b-11ee-bf11-b4055da5489b_03.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230619_275/vx2N7_16871708394633Ea8I_JPEG/8cc0001b-0e8b-11ee-bf11-b4055da5489b_03.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[2].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">3</b> <span class="time"><span class="blind">재생시간</span>00:28</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230616_149/EZd7h_1686898848379LdpuG_JPEG/67d9c1d4-0c13-11ee-bf6e-a0369ffde940_03.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230616_149/EZd7h_1686898848379LdpuG_JPEG/67d9c1d4-0c13-11ee-bf6e-a0369ffde940_03.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[3].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">4</b> <span class="time"><span class="blind">재생시간</span>02:11</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230525_111/LtdRq_1684979849836wibnX_JPEG/clip_20230525104205_0.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230525_111/LtdRq_1684979849836wibnX_JPEG/clip_20230525104205_0.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[4].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">5</b> <span class="time"><span class="blind">재생시간</span>02:00</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230522_254/qV4yD_1684727575823fF76H_JPEG/%B3%AA%BF%EC-2-%BD%E6%B3%D7%C0%CF.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230522_254/qV4yD_1684727575823fF76H_JPEG/%B3%AA%BF%EC-2-%BD%E6%B3%D7%C0%CF.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
