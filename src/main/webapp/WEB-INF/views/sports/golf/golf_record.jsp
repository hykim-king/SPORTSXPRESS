...
<div class="record_summary_area">
  <span class="record_timeline"><%= formattedDate %>기준</span>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="record_foreign_player">
        <!-- [D] 선수 이미지 없을 시 .thumbnail 에서 img 태그 제거해주세요. -->
        <span class="thumbnail">
          <img src="${players.profile}" width="32" height="32" alt="" onerror="$(this).closest('span.thumbnail').html('');">
        </span>
        <span class="name">${players.name}</span>
      </div>
    </td>
    <td>
      <div class="record_group">${players.nation}</div>
    </td>
    <td>
      <div class="record_data" data-record-column="earningsAmount">${players.ernings}</div>
    </td>
    <td>
      <div class="record_data " data-record-column="winsPoint">${players.point}</div>
    </td>
    <td>
      <div class="record_data " data-record-column="scoringAvg">${players.savg}</div>
    </td>
    <td>
      <div class="record_data " data-record-column="driveAvg">${players.ddavg}</div>
    </td>
    <td>
      <div class="record_data " data-record-column="greenPct">${players.appgrn}</div>
    </td>
    <td>
      <div class="record_data " data-record-column="puttAvg">${players.pavg}</div>
    </td>
    <td>
      <div class="record_data " data-record-column="driveAcc">${players.fhit}</div>
    </td>
    <td>
      <div class="record_data " data-record-column="top10">${players.top10f}</div>
    </td>
  </tr>
