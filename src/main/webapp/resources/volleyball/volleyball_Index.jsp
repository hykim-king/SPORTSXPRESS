...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/volleyball/news/index" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.kvolleyball', 'kvolleyball', '', event); ">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/volleyball/record/index" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.record', 'record', '', event); ">
