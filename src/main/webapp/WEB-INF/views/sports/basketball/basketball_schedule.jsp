...
<link rel="stylesheet" type="text/css"
	href="https://ssl.pstatic.net/static.sports/resources/pc/8088/66/88/664600/css/volleyball_gamecenter.css">
...
<body>
	<div id="wrap">
			...
			<nav class="sports_lnb_sub">
				<ul id="lnb_sub_list" class="lnb_sub_list" role="menubar">
					...
					<li class="lnb_sub_item " role="presentation"><a
						href="/ehr/sportsxpress/basketball_news.do" class="link_lnb_sub"
						role="menuitem"
			...
			<div id="content">
				...
				<div class="tab_event">
					<ul class="list" id="_categoryList">
						...
						<li class="selected"><a href="/schedule/index?category=kbl"
							data-category="kbl"><span class="menu">프로농구</span></a></li>



					</ul>
				</div>
				<div class="sch_volleyball tb_kbl">
					...
					<div id="sch_recent_scoreboard" class="sch_game">
						...
						<div class="sch_score kbl_nba">
							<ul class="tab">
								<li class="btn_prev2"><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230429');return false"
									title="이전">이전</a></li>

								<li><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230501');">
										<em>5.01</em>(월)

								</a></li>

								<li><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230502');">
										<em>5.02</em>(화)

								</a></li>

								<li><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230503');">
										<em>5.03</em>(수)

								</a></li>

								<li><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230504');">
										<em>5.04</em>(목)

								</a></li>

								<li><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230505');">
										<em>5.05</em>(금)

								</a></li>

								<li><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230506');">
										<em>5.06</em>(토)

								</a></li>

								<li class="on"><a href="#"
									onclick="javascript:scoreBoardInstance.setScoreBoard('20230507');">
										<em>5.07</em>(일)

								</a></li>

								<li class="btn_next2"><a href="#"
							...
							<div class="sch_vs" id="todaySchedule0">
								<div class="inner_lft end">
									...
									<div class="vs_lft">
										<div class="emblem">
											<img class="sch_emblem" width="64" height="64" alt="안양 KGC"
												title="안양 KGC" src="${matches[6].hname_logo}"
												onerror="imageOnError(this);">
										</div>
										<span class="vs_team">${matches[6].hname}</span> <strong
											class="vs_num">${matches[6].hscore}<span
											class="vs_bg"></span></strong>
									</div>
									<div class="vs_rgt">
										<div class="emblem">
											<img class="sch_emblem" width="64" height="64" alt="서울 SK"
												title="서울 SK" src="${matches[6].ateam_logo}"
												onerror="imageOnError(this);">
										</div>
										<span class="vs_team">${matches[6].ateam}</span> <strong
											class="vs_num">${matches[6].ascore}</strong>
									</div>
									<div class="vs_btn">
					...
					<form name="monthlyScheduleForm" id="monthlyScheduleForm"
						...
						<input type="hidden" name="year" id="year" value="2023"> <input
							type="hidden" name="month" id="month" value="05"> <input
							type="hidden" name="teamCode" id="teamCode" value=""> <input
							type="hidden" name="date" id="date" value="20230507">
					</form>
       ...
       -->
								<button class="btn_toggle" id="_currentYearButton" type="button"
									aria-haspopup="listbox" aria-expanded="false"
									aria-label="연도 선택" onclick="toggleYearList();">
								...
								<ul class="option_list" role="listbox" id="_yearList">
									...
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="true"
											onclick="changeSchedule('2023','05','');">2023</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2022','05','');">2022</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2021','05','');">2021</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2020','05','');">2020</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2019','05','');">2019</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2018','05','');">2018</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2017','05','');">2017</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2016','05','');">2016</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2015','05','');">2015</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2014','05','');">2014</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2013','05','');">2013</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2012','05','');">2012</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2011','05','');">2011</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2010','05','');">2010</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2009','05','');">2009</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2008','05','');">2008</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2007','05','');">2007</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2006','05','');">2006</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2005','05','');">2005</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2004','05','');">2004</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2003','05','');">2003</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2002','05','');">2002</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2001','05','');">2001</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2000','05','');">2000</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('1999','05','');">1999</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('1998','05','');">1998</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('1997','05','');">1997</button>
									</li>
       ...
       -->
								<button class="btn_toggle" type="button" aria-haspopup="listbox"
									aria-expanded="false" aria-label="월 선택"
									id="_currentMonthButton" onclick="toggleMonthList();">
								...
								<ul class="option_list" role="listbox" id="_monthList">
									...
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2023','01','');">01</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2023','02','');">02</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2023','03','');">03</button>
									</li>

									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false"
											onclick="changeSchedule('2023','04','');">04</button>
									</li>
							...
							<button class="btn_move_date prev" type="button"
								onclick="clickcr(this, 'sch.prevmonth', '', '', event);changeSchedule('2023','04','');">
								<span class="blind">이전 달로 이동</span>
							</button>
							<button class="btn_move_date next" type="button" disabled=""
								onclick="clickcr(this, 'sch.nextmonth', '', '', event);changeSchedule('2023','05','');">
								<span class="blind">다음 달로 이동</span>
							</button>
						</div>

						<div class="now_date_area">
							<button class="btn_now_date" type="button"
								onclick="changeSchedule('2023','06','');">
             ...
             <c:forEach var="matches" items="${matches}" varStatus="loop">
									...
									<tr>
										<c:choose>
											<c:when test="${loop.count % 7 == 1}">
												<td rowspan="1"><span class="td_date"><strong>5.${loop.count}</strong>
														(월)</span></td>
											</c:when>
										...
										<td><span class="team_lft">${matches.hname}</span> <span
											class="emblem"><img src="${matches.hname_logo}"
												onerror="imageOnError(this);" width="25" height="25"
												alt="서울 SK" title="서울 SK"></span> <strong class="td_score">${matches.hscore}<em>:</em>${matches.ascore}
										</strong> <span class="emblem"><img src="${matches.ateam_logo}"
												onerror="imageOnError(this);" width="25" height="25"
												alt="안양 KGC" title="안양 KGC"></span> <span class="team_rgt">${matches.ateam}</span>
										</td>
										<td><span class="td_btn"> <a
												href="/game/20230501557041044/relay"><img
													src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_wd.gif"
													width="61" height="23" alt="문자중계"></a> <a
												href="/game/20230501557041044/record"><img
													src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_rcd.gif"
													width="61" height="23" alt="경기기록"></a> <a
												href="https://m.sports.naver.com/basketball/video?category=kbl&amp;gameId=20230501557041044&amp;tab=game&amp;date=2023-05-01&amp;sort=date"
												onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img
				...
				<div class="gamedata_info">
					...
					사항은 <a
						...
						target="_blank">고객센터</a>를 통해서 문의해주시기 바랍니다.
				</div>
