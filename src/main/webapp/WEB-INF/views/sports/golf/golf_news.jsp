...
<html>
    <head>
        ...
        <script type="text/javascript" src="https://ssl.pstatic.net/tveta/libs/glad/prod/2.16.1/gfp-sdk.js" async="" charset="utf-8"></script>
        ...
        <script type="text/javascript" src="https://ssl.pstatic.net/tveta/libs/glad/prod/2.15.0/gfp-sdk.js" async="" charset="utf-8"></script>
        <script type="text/javascript" src="https://ssl.pstatic.net/tveta/libs/glad/prod/2.15.0/gfp-sentry-bundle-1.0.1.js" async="" charset="utf-8"></script>
        <script type="text/javascript" src="https://ssl.pstatic.net/tveta/libs/glad/prod/2.15.0/gfp-ext-nda.js" async="" charset="utf-8"></script>
    ...
    <body>
        ...
        <div id="wrap">
            <header id="header" class="sports_header_pc type_golf">
                        ...
                        <div class="gnb_one" id="gnb">
                            ...
                            <ul class="gnb_lst" id="gnb_lst" style="display: none;">
                                <li class="gnb_login_li" id="gnb_login_layer">
                                    <a class="gnb_btn_login" href="#" id="gnb_login_button"><span class="gnb_bg"></span><span class="gnb_bdr"></span><span class="gnb_txt">로그인</span></a>
                                </li>
                                <li class="gnb_my_li" id="gnb_my_layer" style="display: none;">
                                        ...
                                        <div class="gnb_my_content">
                                            ...
                                            <div class="gnb_txt_area">
                                                <p class="gnb_account">
                                                    ...
                                                    <a class="gnb_btn_login" href="#" id="gnb_logout_button"><span class="gnb_bg"></span><span class="gnb_bdr"></span><span class="gnb_txt">로그아웃</span></a>
                                                </p>
                                    ...
                                    <iframe
                                        ...
                                        scrolling="no"
                                        frameborder="0"
                                        style="top: 34px; right: -4px; width: 320px; height: 158px; display: none; opacity: 0; -ms-filter: alpha(opacity = 0);"
                                    ></iframe>
                                </li>
                                ...
                                <li class="gnb_service_li" id="gnb_service_layer">
                                    ...
                                    <iframe
                                        ...
                                        scrolling="no"
                                        frameborder="0"
                                        style="display: none; top: 34px; right: 297px; width: 585px; height: 385px; opacity: 0; -ms-filter: alpha(opacity = 0);"
                                    ></iframe>
                                    <iframe
                                        ...
                                        scrolling="no"
                                        frameborder="0"
                                        style="display: none; top: 34px; right: -4px; width: 295px; height: 385px; opacity: 0; -ms-filter: alpha(opacity = 0);"
                                    ></iframe>
                                </li>
                            </ul>
                        </div>
                ...
                <nav class="sports_lnb" role="navigation" id="_sports_lnb_menu">
                    ...
                    <ul id="lnb_list" class="lnb_list" role="menubar">
                        ...
                        <li class="lnb_item" role="presentation"><a href="/ehr/sportsxpress/golf_news.do" class="link_lnb" role="menuitem" aria-current="true" onclick="clickcr(this, 'LNB.golf', 'golf', '', event); ; ">골프</a></li>
                    </ul>
                </nav>
                <nav class="sports_lnb_sub">
                    <ul id="lnb_sub_list" class="lnb_sub_list" role="menubar">
                        <li class="lnb_sub_item" role="presentation">
                            <a href="/ehr/sportsxpress/golf_news.do" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.news', 'news', '', event); " aria-current="page"> <span class="menu">최신뉴스</span> </a>
                        </li>
            ...
            <div id="container">
                            ...
                            <div class="content_area">
                                <div class="tab_event">
                                    <ul class="list" id="_sectionList">
                                        <li class="selected" data-id="golf">
                                            <a href="#" onclick="clickcr(this, 'nwl.league', '', '', event);"><span class="menu">N골프 전체</span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="news_lnb">
                                ...
                                <div class="paginate" id="_pageList" style="">
                                    <strong>1</strong> <a href="#" data-id="2" onclick="clickcr(this, 'nwl.paging', '', '', event);">2</a> <a href="#" data-id="3" onclick="clickcr(this, 'nwl.paging', '', '', event);">3</a>
                            ...
                            <div id="news_best" class="aside_inner">
                                ...
                                <div class="aside_rank_news">
                                    ...
                                    <ul class="aside_news_list" id="_ranking_news_list_0" style="display: none;">
                                        ...
                                        <li>
                                            <a href="/news?oid=052&amp;aid=0001894934" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);">
                                                <span><b> '장타 신인' 방신실 "멀리 똑바로요? 이 3가지만 기억하세요"</b></span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=001&amp;aid=0013992243" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);"><span> LPGA 투어 홈페이지에 실린 오툴·홀의 '동성 커플' 이야기</span></a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=119&amp;aid=0002719962" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);"><span> 걱정 던 정찬민 “PGA·LIV 통합, 선수 입장에서 반갑다”</span></a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=011&amp;aid=0004199978" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);"><span> 루키 김성현, 공동 5위…올해 첫 톱10 잰걸음</span></a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=025&amp;aid=0003285792" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);">
                                                <span> 김성현, PGA투어 캐나다 오픈 첫날 공동 5위…공동선두 그룹과 1타 차</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=018&amp;aid=0005503984" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);">
                                                <span><b> 대기자에서 우승자로 신분 바뀐 방신실 "욕심 내려놓고 초심으로"</b></span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=470&amp;aid=0000016003" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);"><span> 김효주·신지은, 유해란·린지 위버... LPGA 숍클래식 조편성 확정</span></a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=018&amp;aid=0005504171" class="title" onclick="clickcr(this, 'aec*a.category', '', '', event);"><span> PGA 투어-LIV 골프 통합 이끈 사람은 ‘파워 브로커’ 지미 던</span></a>
                                        </li>
                                    </ul>
                                    <ul class="aside_news_list" id="_ranking_news_list_1" style="">
                                        <li>
                                            <a href="/news?oid=468&amp;aid=0000950917" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span> LG 키움 NC 3명 가득 승선·SSG 롯데도 핵심 출전, 시즌 막바지 대혼전 예고[SS포커스]</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=421&amp;aid=0006855821" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span> [U20 월드컵] 이탈리아 감독 "탄탄했던 한국…배준호 굉장히 훌륭한 선수"</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=109&amp;aid=0004866654" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span><b> '맨유-뉴캐슬 영입 줄다리기' 김민재, "김민재 대체 2명의 日선수, 능력 안된다" 이탈리아 현지 매체 냉철한 분석</b></span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=139&amp;aid=0002184352" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span> SON 파트너로 계속 남아줬으면 좋겠어...토트넘의 요청, ‘이적료 깎아줘’</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=477&amp;aid=0000433526" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span> '더티 축구' 이탈리아, 20년 전과 달라진 게 없다…손•팔꿈치 쓰며 파울만 26개</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=117&amp;aid=0003737931" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span> “꼴 보기 싫었다” 코치의 팩폭…LG 23세 3루수의 반전, 흐뭇한 ‘폭탄 돌리기’</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=410&amp;aid=0000942762" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span> [단독] 브랜든 이어 쿠에바스도 KBO 컴백 초읽기, ‘탈꼴찌’ KT도 승부수 던졌다</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=108&amp;aid=0003158254" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);">
                                                <span><b> 'KIM 영입 확률' 뉴캐슬＞맨유, 판 바뀌었다... "코드명 '김민재 사냥'-681억 하이재킹 준비"</b></span>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="/news?oid=241&amp;aid=0003280809" class="title" onclick="clickcr(this, 'aec*a.sports', '', '', event);"><span> 입장권 가격 1034%↑…마이애미 흔드는 '메시 효과'</span></a>
                                        </li>
                                    ...
                                    <ul class="aside_vod_list2">
                                            ...
                                            <a href="${videos[0].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    ...
                                                    <img
                                                        width="260"
                                                        height="156"
                                                        src="https://phinf.pstatic.net/tvcast/20230505_177/7hEeC_1683276292669CPy9n_JPEG/bandicam_2023-05-05_17-43-20-353.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230505_177/7hEeC_1683276292669CPy9n_JPEG/bandicam_2023-05-05_17-43-20-353.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[1].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">2</b> <span class="time"><span class="blind">재생시간</span>00:59</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230514_261/Q3Qbz_16840470169642cmJc_JPEG/bandicam_2023-05-14_15-44-48-350.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230514_261/Q3Qbz_16840470169642cmJc_JPEG/bandicam_2023-05-14_15-44-48-350.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[2].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">3</b> <span class="time"><span class="blind">재생시간</span>00:15</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230514_228/au2B7_1684032460693rknEd_JPEG/bandicam_2023-05-14_11-43-56-794.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230514_228/au2B7_1684032460693rknEd_JPEG/bandicam_2023-05-14_11-43-56-794.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[3].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">4</b> <span class="time"><span class="blind">재생시간</span>00:31</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230504_223/YN5Ye_1683174598214YqEgw_JPEG/bandicam_2023-05-04_13-29-34-613.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230504_223/YN5Ye_1683174598214YqEgw_JPEG/bandicam_2023-05-04_13-29-34-613.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                                        ...
                                        <li class="vod_li">
                                            <a href="${videos[4].hyperlink}" onclick="clickcr(this, 'aec*b.video', '', '', event);" title="">
                                                <div class="thmb">
                                                    <b class="rank_num">5</b> <span class="time"><span class="blind">재생시간</span>01:32</span> <span class="mask"></span>
                                                    <img
                                                        width="110"
                                                        height="64"
                                                        src="https://phinf.pstatic.net/tvcast/20230514_193/gsbK0_1684046215697833F2_JPEG/20230514_klpga_fr_phy_n18_%C0%D3%C1%F8%C8%F1_17%B9%F8%C8%A6.jpg?type=f172_97_blend_webp"
                                                        class="imageLazyLoad"
                                                        lazy-src="https://phinf.pstatic.net/tvcast/20230514_193/gsbK0_1684046215697833F2_JPEG/20230514_klpga_fr_phy_n18_%C0%D3%C1%F8%C8%F1_17%B9%F8%C8%A6.jpg?type=f172_97_blend_webp"
                                                        alt=""
                                                        onerror="imageOnError(this);"
                                                    />
                                                </div>
                ...
                <script id="_newsListTemplate" type="text/x-handlebars-template"></script>
                <script id="_emptyList"></script>

                <script id="_pageListTemplate" type="text/x-handlebars-template"></script>

                <script id="_bottomDateListTemplate" type="text/x-handlebars-template"></script>
                <script type="text/javascript"></script>
                <script></script>
            </div>
            ...
            <div id="footer">
                <div class="inner">
                    ...
                    <div class="sports_info">
                        <div class="link_area">
                            <div class="main_area">
                                <a href="javascript:naverLogout();" class="link" id="login_status">로그아웃</a> <a href="https://www.naver.com/more.html" class="link sitemap">전체서비스</a>
