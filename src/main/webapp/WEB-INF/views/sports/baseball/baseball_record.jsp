...
<head>
    ...
    <meta property="og:url" content="sports.news.naver.com/kbaseball/record/index?category=kbo&amp;tab=team">
...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/ehr/sportsxpress/baseball_record.do" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.datacenter', 'datacenter', '', event); " aria-current="page">
...
<div class="tb_kbo">
  <h2 class="h_sch"><span>KBO리그 기록 및 순위</span></h2>
  <div class="rr_wrap">
...
<div class="date_select_nav type_year_month">
    ...
    <div class="select_box_area type_date">
       ...
       -->
            ...
            <ul class="option_list" role="listbox" id="_yearList">
                ...
                <!-- [D] 비활성화 되어야 하는 button.btn_option 에 disabled 속성을 추가 해 주세요. -->
                    ...
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="true" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2023'">2023</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2022'">2022</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2021'">2021</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2020'">2020</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2019'">2019</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2018'">2018</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2017'">2017</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2016'">2016</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2015'">2015</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2014'">2014</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2013'">2013</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2012'">2012</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2011'">2011</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2010'">2010</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2009'">2009</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2008'">2008</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2007'">2007</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2006'">2006</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2005'">2005</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2004'">2004</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2003'">2003</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2002'">2002</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2001'">2001</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2000'">2000</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1999'">1999</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1998'">1998</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1997'">1997</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1996'">1996</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1995'">1995</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1994'">1994</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1993'">1993</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1992'">1992</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=1991'">1991</button>
                    </li>
        ...
        <!-- [D] 비활성화 되어야 하는 button.btn_move_date 에 disabled 속성을 추가 해 주세요. -->
                ...
                <button class="btn_move_date prev" type="button" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2022'"><span class="blind">이전 시즌으로 이동</span></button>
    ...
    <div class="now_date_area">
        <button class="btn_now_date" type="button" onclick="location.href='/kbaseball/record/index?category=kbo&amp;year=2023'">현재<span class="blind">시즌으로 이동</span></button>
    </div>
</div>
</div>
<div class="tbl_box">
    <table cellspacing="0" cellpadding="0">
        ...
        <tbody id="regularTeamRecordList_table">
            ...
            <tr>
                ...
                <td><span>0.0</span></td>
                <td><span>3승</span></td>
                <td><span>0.329</span></td>
                <td><span>0.383</span></td>
                <td><span>8승-2패-0무</span></td>
            </tr>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LG.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
                ...
                <td><span>2.5</span></td>
                <td><span>1패</span></td>
                <td><span>0.366</span></td>
                <td><span>0.390</span></td>
                <td><span>4승-5패-1무</span></td>
            </tr>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/NC.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
                ...
                <td><span>6.5</span></td>
                <td><span>2승</span></td>
                <td><span>0.348</span></td>
                <td><span>0.382</span></td>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/OB.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
                ...
                <td><span>7.0</span></td>
                <td><span>3승</span></td>
                <td><span>0.326</span></td>
                <td><span>0.365</span></td>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SS.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/KT.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
                ...
                <td><span>1승</span></td>
                <td><span>0.325</span></td>
                <td><span>0.349</span></td>
                <td><span>4승-5패-1무</span></td>
            </tr>
            ...
            <tr>
                ...
                <td class="tm">
                    <div>
                                ...
                                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HH.png&amp;type=f25_25&amp;refresh=1" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
                ...
                <td><span>3패</span></td>
                <td><span>0.312</span></td>
                <td><span>0.319</span></td>
                <td><span>4승-6패-0무</span></td>
            </tr>
    ...
    <div class="wnrt_on" id="regularTeamRecordList_ColumnChecker">
        <span class="bl" style="height: 351px;"></span>
        <span class="bt"></span>
        <span class="br" style="height: 351px;"></span>
...
<div class="tit_box2">
  <h4><span>주요 부문 선두</span></h4>
</div>

<div class="tbl_box p_head">
    ...
    <table cellspacing="0" cellpadding="0" class="pitcher">
      <caption>
          다승,평균자책,탈삼진,세이브 부문 선두 테이블
      </caption>
      <thead>
      <tr>
          ...
          <th>
            <div class="">
              <strong class="title">다승 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">평균자책 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">탈삼진 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">세이브 순위</strong>
            </div>
          </th>
      ...
      <tr>
          ...
          <td class="">
            <div class="ph">
                  ...
                  <em class="ply_img"><img src="https://sports-phinf.pstatic.net/player/kbo/default/53913.png?type=h176" height="88" alt="" onerror="imageOnError(this);"></em>
                  <ol class="ph_rank">
                    
                      
                        
                          <li class="lead"><span class="ord">1</span>
                            <strong>페디</strong>
          ...
          <td class="">
            <div class="ph">
                  ...
                  <em class="ply_img"><img src="https://sports-phinf.pstatic.net/player/kbo/default/68341.png?type=h176" height="88" alt="" onerror="imageOnError(this);"></em>
                  <ol class="ph_rank">
          ...
          <td class="">
            <div class="ph">
                  ...
                  <em class="ply_img"><img src="https://sports-phinf.pstatic.net/player/kbo/default/61895.png?type=h176" height="88" alt="" onerror="imageOnError(this);"></em>
                  <ol class="ph_rank">
    ...
    <table cellspacing="0" cellpadding="0" class="hitter">
      <caption>
          타율,타점,홈런,도루 부문 선두 테이블
      </caption>
      <thead>
      <tr>
          ...
          <th>
            <div class="">
              <strong class="title">타율 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">타점 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">홈런 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">도루 순위</strong>
            </div>
          </th>
      ...
      <tr>
          ...
          <td class="">
            <div class="ph">
                  ...
                  <em class="ply_img"><img src="https://sports-phinf.pstatic.net/player/kbo/default/78603.png?type=h176" height="88" alt="" onerror="imageOnError(this);"></em>
                  <ol class="ph_rank">
          ...
          <td class="">
            <div class="ph">
                  ...
                  <em class="ply_img"><img src="https://sports-phinf.pstatic.net/player/kbo/default/79365.png?type=h176" height="88" alt="" onerror="imageOnError(this);"></em>
                  <ol class="ph_rank">
          ...
          <td class="">
            <div class="ph">
                  ...
                  <em class="ply_img"><img src="https://sports-phinf.pstatic.net/player/kbo/default/67304.png?type=h176" height="88" alt="" onerror="imageOnError(this);"></em>
                  <ol class="ph_rank">
    ...
    <table cellspacing="0" cellpadding="0" class="etc">
      <caption>
          WHIP,OPS,투수 WAR,타자 WAR 부문 선두 테이블
      </caption>
      <thead>
      <tr>
          ...
          <th>
            <div class="">
              <strong class="title">WHIP 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">OPS 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">투수 WAR 순위</strong>
            </div>
          </th>
        
          <th>
            <div class="">
              <strong class="title">타자 WAR 순위</strong>
            </div>
          </th>
      ...
      <tr>
          ...
          <td class="">
            <div class="ph">
                  ...
                  <em class="ply_img"><img src="https://sports-phinf.pstatic.net/player/kbo/default/69045.png?type=h176" height="88" alt="" onerror="imageOnError(this);"></em>
                  <ol class="ph_rank">
...
<div class="tit_box2">
  <div class="tab_event">
    <ul class="list" id="_playerTypeList">
      <li class="selected" data-player-type-id="pitcher"><a href="#"><span class="menu">투수 순위<span class="blind">선택됨</span></span></a></li>
      <li data-player-type-id="batter"><a href="#"><span class="menu">타자 순위</span></a></li>
    </ul>
  </div>
</div>
  ...
  <div id="_pitcherRecord" class="tbl_box pitcher tbl_paging _playerRecordDiv">
        ...
        <thead>
          <tr>
            ...
            <th>
              ...
              <th>
                <div class="era" data-stats-code="era">
                  <a href="#">
                    <strong class="sort"><span class="blind">평균자책점</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="gcnt_s" data-stats-code="game_count">
                  <a href="#">
              ...
              <th>
                <div class="inning" data-stats-code="inn">
                  <a href="#">
                    <strong><span class="blind">이닝</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="wpnt" data-stats-code="w">
                  <a href="#">
                    <strong><span class="blind">승</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="lpnt" data-stats-code="l">
                  <a href="#">
                    <strong><span class="blind">패</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="save" data-stats-code="sv">
                  <a href="#">
                    <strong><span class="blind">세이브</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="hold" data-stats-code="hold">
                  <a href="#">
                    <strong><span class="blind">홀드</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="strikeout" data-stats-code="kk">
                  <a href="#">
                    <strong><span class="blind">삼진</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="hitball" data-stats-code="hit">
                  <a href="#">
                    <strong><span class="blind">피안타</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="homerunball" data-stats-code="hr">
                  <a href="#">
                    <strong><span class="blind">피홈런</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="losepoint" data-stats-code="r">
                  <a href="#">
                    <strong><span class="blind">실점</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="fourball" data-stats-code="bb">
                  <a href="#">
                    <strong><span class="blind">볼넷</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="deadball" data-stats-code="hp">
                  <a href="#">
                    <strong><span class="blind">사구</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="wnrt" data-stats-code="winp">
                  <a href="#">
                    <strong><span class="blind">승률</span></strong>
                  </a>
                </div>
              </th>
...
<tr class=" on">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/NC.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>페디 <span class="team">(NC)</span></span>
    </div>
  </td>
  <td>
    <strong>1.63</strong>
...
<tr class=" on">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/OB.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>알칸타라 <span class="team">(두산)</span></span>
    </div>
  </td>
  <td>
    <strong>1.77</strong>
...
<tr class=" on">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>안우진 <span class="team">(키움)</span></span>
    </div>
  </td>
  <td>
    <strong>1.87</strong>
...
<tr class=" on">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LG.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>플럿코 <span class="team">(LG)</span></span>
    </div>
  </td>
  <td>
    <strong>1.97</strong>
...
<tr class="dv on">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LT.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>나균안 <span class="team">(롯데)</span></span>
    </div>
  </td>
  <td>
    <strong>2.55</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SK.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>맥카티 <span class="team">(SSG)</span></span>
    </div>
  </td>
  <td>
    <strong>2.64</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>최원태 <span class="team">(키움)</span></span>
    </div>
  </td>
  <td>
    <strong>2.82</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>후라도 <span class="team">(키움)</span></span>
    </div>
  </td>
  <td>
    <strong>3.10</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SS.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>백정현 <span class="team">(삼성)</span></span>
    </div>
  </td>
  <td>
    <strong>3.11</strong>
...
<tr class="dv">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LT.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>박세웅 <span class="team">(롯데)</span></span>
    </div>
  </td>
  <td>
    <strong>3.17</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HH.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>페냐 <span class="team">(한화)</span></span>
    </div>
  </td>
  <td>
    <strong>3.25</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/KT.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>고영표 <span class="team">(KT)</span></span>
    </div>
  </td>
  <td>
    <strong>3.29</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SS.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>뷰캐넌 <span class="team">(삼성)</span></span>
    </div>
  </td>
  <td>
    <strong>3.46</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SK.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>오원석 <span class="team">(SSG)</span></span>
    </div>
  </td>
  <td>
    <strong>3.49</strong>
...
<tr class="dv">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LG.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>켈리 <span class="team">(LG)</span></span>
    </div>
  </td>
  <td>
    <strong>4.07</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LT.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>스트레일리 <span class="team">(롯데)</span></span>
    </div>
  </td>
  <td>
    <strong>4.11</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/SS.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>원태인 <span class="team">(삼성)</span></span>
    </div>
  </td>
  <td>
    <strong>4.17</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/HT.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>앤더슨 <span class="team">(KIA)</span></span>
    </div>
  </td>
  <td>
    <strong>4.20</strong>
...
<tr class="">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/LT.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>반즈 <span class="team">(롯데)</span></span>
    </div>
  </td>
  <td>
    <strong>4.20</strong>
...
<tr class="dv">
  ...
  <td class="ply">
    <div>
      <span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbo/default/WO.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
      <span>요키시 <span class="team">(키움)</span></span>
    </div>
  </td>
  <td>
    <strong>4.39</strong>
        ...
        <thead>
          <tr>
            ...
            <th>
              ...
              <th>
                <div class="whip" data-stats-code="whip">
                  <a href="#">
                    <strong><span class="blind">WHIP</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="k9" data-stats-code="innk">
                  <a href="#">
                    <strong><span class="blind">K/9</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="bb9" data-stats-code="innb">
                  <a href="#">
                    <strong><span class="blind">BB/9</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="kbb" data-stats-code="kk_bb_rt">
                  <a href="#">
                    <strong><span class="blind">K/BB</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="kp" data-stats-code="pa_kk_rt">
                  <a href="#">
                    <strong><span class="blind">K%</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="bbp" data-stats-code="pa_bb_rt">
                  <a href="#">
                    <strong><span class="blind">BB%</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="wpa" data-stats-code="wpa">
                  <a href="#">
                    <strong><span class="blind">WPA</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="war" data-stats-code="war">
                  <a href="#">
                    <strong><span class="blind">WAR</span></strong>
                  </a>
                </div>
              </th>
...
<tr class="dv">
  ...
  <div id="_batterRecord" class="tbl_box hitter tbl_paging _playerRecordDiv" style="display:none">
        ...
        <thead>
          <tr>
            ...
            <th>
              ...
              <th>
                <div class="batavg" data-stats-code="hra">
                  <a href="#">
                    <strong><span class="blind">타율</span></strong>
                  </a>
                </div>
              </th>
              ...
              <th>
                <div class="atbat" data-stats-code="ab">
                  <a href="#">
                    <strong><span class="blind">타수</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="hit" data-stats-code="hit">
                  <a href="#">
                    <strong><span class="blind">안타</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="twobasehit" data-stats-code="h2">
                  <a href="#">
                    <strong><span class="blind">2루타</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="threebasehit" data-stats-code="h3">
                  <a href="#">
                    <strong><span class="blind">3루타</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="homerun" data-stats-code="hr">
                  <a href="#">
                    <strong><span class="blind">홈런</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="rbi" data-stats-code="rbi">
                  <a href="#">
                    <strong><span class="blind">타점</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="score" data-stats-code="run">
                  <a href="#">
                    <strong><span class="blind">득점</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="steal" data-stats-code="sb">
                  <a href="#">
                    <strong><span class="blind">도루</span></strong>
                  </a>
                </div>
              </th>
              ...
              <th>
                <div class="onbase" data-stats-code="obp">
                  <a href="#">
                    <strong><span class="blind">출루율</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="slugging" data-stats-code="slg">
                  <a href="#">
                    <strong><span class="blind">장타율</span></strong>
                  </a>
                </div>
              </th>
        ...
        <thead>
          <tr>
            ...
            <th>
              ...
              <th>
                <div class="ops" data-stats-code="ops">
                  <a href="#">
                    <strong><span class="blind">OPS</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="lsop" data-stats-code="isop">
                  <a href="#">
                    <strong><span class="blind">IsoP</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="babip" data-stats-code="babip">
                  <a href="#">
                    <strong><span class="blind">BABIP</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="woba" data-stats-code="woba">
                  <a href="#">
                    <strong><span class="blind">wOBA</span></strong>
                  </a>
                </div>
              </th>
            
              <th>
                <div class="wrc" data-stats-code="wrc_plus">
                  <a href="#">
                    <strong><span class="blind">wRC+</span></strong>
                  </a>
                </div>
              </th>
...
<div class="record_info">
    ...
    <ul class="p_noti">
                ...
                <li>※ 야구 순위는 시즌 종료 시 전년도 순위 기준으로 노출되며, 개막일 이후 새 시즌 순위표로 노출됩니다.</li>
