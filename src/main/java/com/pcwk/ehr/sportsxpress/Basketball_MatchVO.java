...
public class Basketball_MatchVO extends DTO {
	...
	public Basketball_MatchVO() {

	}
	
	
	
	public Basketball_MatchVO(int basketno, String season, String lname, String time, String location, String hname,
	...
	public String toString() {
		return "Basketball_MatchVO [basketno=" + basketno + ", season=" + season + ", lname=" + lname + ", time=" + time
