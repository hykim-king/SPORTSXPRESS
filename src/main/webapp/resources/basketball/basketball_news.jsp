...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/basketball/news/index" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.news', 'news', '', event); " aria-current="page">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/basketball/record/index?category=kbl" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.record', 'record', '', event); ">
