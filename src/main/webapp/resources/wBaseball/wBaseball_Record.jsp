...
<head>
    ...
    <meta property="og:url" content="sports.news.naver.com/wbaseball/record/index?category=mlb&amp;league=NL&amp;tab=team">
            ...
            <title>기록/순위, 해외야구 : 네이버 스포츠</title>
...
<nav class="sports_lnb_sub">
	...
	<li class="lnb_sub_item " role="presentation">
		<a href="/wbaseball/record/index" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.record', 'record', '', event); " aria-current="page">
...
<div class="tab_event">
    <ul class="list">
        <li class="selected"><a href="/wbaseball/record/index?category=mlb"><span class="menu">메이저리그<span class="blind">선택됨</span></span></a></li>
        <li><a href="/wbaseball/record/index?category=npb"><span class="menu">일본야구</span></a></li>
    </ul>
</div>
<div class="record_tab">
    <ul class="list">
        <li class="selected">
            <a href="/wbaseball/record/index?category=mlb&amp;league=NL&amp;year=2023">
						<span class="menu">
							<img src="https://imgsports.pstatic.net/images/2016/pc/common/league/mlb_nl_on.png" height="23" alt="" onerror="imageOnError(this);">
							<span class="title">내셔널리그</span>
                            <span class="blind">선택됨</span>
						</span>
            </a>
        </li>
        <li>
            <a href="/wbaseball/record/index?category=mlb&amp;league=AL&amp;year=2023">
						<span class="menu">
							<img src="https://imgsports.pstatic.net/images/2016/pc/common/league/mlb_al.png" height="23" alt="" onerror="imageOnError(this);">
							<span class="title">아메리칸리그</span>
...
<div class="record_sub_title">
    <h4 class="record_h">팀 순위</h4>
</div>
<div class="date_select_nav type_year_month">
    ...
    <div class="select_box_area type_date">
            ...
            <ul class="option_list" role="listbox" id="_yearList">
                ...
                <!-- [D] 비활성화 되어야 하는 button.btn_option 에 disabled 속성을 추가 해 주세요. -->
                    ...
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="true" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2023&amp;league=NL'">2023</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2022&amp;league=NL'">2022</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2021&amp;league=NL'">2021</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2020&amp;league=NL'">2020</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2019&amp;league=NL'">2019</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2018&amp;league=NL'">2018</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2017&amp;league=NL'">2017</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2016&amp;league=NL'">2016</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2015&amp;league=NL'">2015</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2014&amp;league=NL'">2014</button>
                    </li>
                
                    <li class="list" role="presentation">
                        <button class="btn_option" type="button" role="option" aria-selected="false" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2013&amp;league=NL'">2013</button>
                    </li>
        ...
        <!-- [D] 비활성화 되어야 하는 button.btn_move_date 에 disabled 속성을 추가 해 주세요. -->
                ...
                <button class="btn_move_date prev" type="button" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2022&amp;league=NL'"><span class="blind">이전 시즌으로 이동</span></button>
    ...
    <div class="now_date_area">
        <button class="btn_now_date" type="button" onclick="location.href='/wbaseball/record/index?category=mlb&amp;year=2023'">현재<span class="blind">시즌으로 이동</span></button>
    </div>
</div>
...
<table>
	<caption>내셔널 리그 동부지구 팀 순위</caption>
	<colgroup>
		<col width="45">
		<col width="*">
		<col width="76">
	...
	<thead>
	<tr>
		<th scope="col" colspan="2" class="align_l">
			<div class="inner">
				<strong class="team_title">동부지구</strong>
			</div>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_gameCount">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','gameCount');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_gameCount">경기수</strong>
			</a>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_won">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','won');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_won">승</strong>
			</a>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_lost">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','lost');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_lost">패</strong>
			</a>
		</th>
		<th scope="col" class="selected" id="eastDivisionTeamRecordList_th_wra">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','wra');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_wra">승률</strong>
			</a>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_winDiff">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','winDiff');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_winDiff">게임차</strong>
			</a>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_streak">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','streak');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_streak">연속</strong>
			</a>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_hra">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','hra');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_hra">타율</strong>
			</a>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_era">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','era');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_era">평균자책</strong>
			</a>
		</th>
		<th scope="col" id="eastDivisionTeamRecordList_th_recent">
			<a href="javascript:sortByColumn('eastDivisionTeamRecordList','recent');" class="inner">
				<strong class="sort" id="eastDivisionTeamRecordList_recent">최근 10경기</strong>
			</a>
		</th>
	</tr>
	</thead>
	<tbody id="eastDivisionTeamRecordList_table">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/AT.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_AT">애틀랜타</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/FL.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_FL">마이애미</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/PH.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_PH">필라델피아</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/NM.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_NM">뉴욕M</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr class="last">
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/MO.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_MO">워싱턴</span>
				</div>
			</td>
			<td>
				<div class="inner">
...
<table>
	...
	<tr>
		<th scope="col" colspan="2" class="align_l">
			<div class="inner">
				<strong class="team_title">중부지구</strong>
			</div>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_gameCount">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','gameCount');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_gameCount">경기수</strong>
			</a>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_won">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','won');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_won">승</strong>
			</a>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_lost">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','lost');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_lost">패</strong>
			</a>
		</th>
		<th scope="col" class="selected" id="centerDivisionTeamRecordList_th_wra">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','wra');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_wra">승률</strong>
			</a>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_winDiff">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','winDiff');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_winDiff">게임차</strong>
			</a>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_streak">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','streak');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_streak">연속</strong>
			</a>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_hra">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','hra');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_hra">타율</strong>
			</a>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_era">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','era');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_era">평균자책</strong>
			</a>
		</th>
		<th scope="col" id="centerDivisionTeamRecordList_th_recent">
			<a href="javascript:sortByColumn('centerDivisionTeamRecordList','recent');" class="inner">
				<strong class="sort" id="centerDivisionTeamRecordList_recent">최근 10경기</strong>
			</a>
		</th>
	</tr>
	</thead>
	<tbody id="centerDivisionTeamRecordList_table">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/MI.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_MI">밀워키</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/PI.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_PI">피츠버그</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/CI.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_CI">신시내티</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/CC.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_CC">시카고C</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr class="last">
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/SL.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_SL">세인트루이스</span>
				</div>
			</td>
			<td>
				<div class="inner">
...
<table>
	...
	<tr>
		<th scope="col" colspan="2" class="align_l">
			<div class="inner">
				<strong class="team_title">서부지구</strong>
			</div>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_gameCount">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','gameCount');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_gameCount">경기수</strong>
			</a>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_won">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','won');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_won">승</strong>
			</a>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_lost">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','lost');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_lost">패</strong>
			</a>
		</th>
		<th scope="col" class="selected" id="westDivisionTeamRecordList_th_wra">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','wra');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_wra">승률</strong>
			</a>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_winDiff">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','winDiff');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_winDiff">게임차</strong>
			</a>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_streak">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','streak');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_streak">연속</strong>
			</a>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_hra">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','hra');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_hra">타율</strong>
			</a>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_era">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','era');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_era">평균자책</strong>
			</a>
		</th>
		<th scope="col" id="westDivisionTeamRecordList_th_recent">
			<a href="javascript:sortByColumn('westDivisionTeamRecordList','recent');" class="inner">
				<strong class="sort" id="westDivisionTeamRecordList_recent">최근 10경기</strong>
			</a>
		</th>
	</tr>
	</thead>
	<tbody id="westDivisionTeamRecordList_table">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/AZ.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_AZ">애리조나</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/LA.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_LA">LAD</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/SF.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_SF">샌프란시스코</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr>
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/SD.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_SD">샌디에이고</span>
				</div>
			</td>
			<td>
				<div class="inner">
		...
		<tr class="last">
			...
			<td class="align_l">
				<div class="inner">
					<span class="emblem"><img width="25" height="25" alt="" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/CO.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);"></span>
					<span class="name" id="team_CO">콜로라도</span>
				</div>
			</td>
			<td>
				<div class="inner">
...
<table>
	...
	<tr>
		<th scope="col" colspan="2" class="align_l">
			<div class="inner">
				<strong class="team_title">와일드카드</strong>
			</div>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_gameCount">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','gameCount');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_gameCount">경기수</strong>
			</a>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_won">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','won');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_won">승</strong>
			</a>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_lost">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','lost');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_lost">패</strong>
			</a>
		</th>
		<th scope="col" class="selected" id="wildCardTeamRecordList_th_wra">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','wra');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_wra">승률</strong>
			</a>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_winDiff">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','winDiff');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_winDiff">게임차</strong>
			</a>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_streak">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','streak');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_streak">연속</strong>
			</a>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_hra">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','hra');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_hra">타율</strong>
			</a>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_era">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','era');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_era">평균자책</strong>
			</a>
		</th>
		<th scope="col" id="wildCardTeamRecordList_th_recent">
			<a href="javascript:sortByColumn('wildCardTeamRecordList','recent');" class="inner">
				<strong class="sort" id="wildCardTeamRecordList_recent">최근 10경기</strong>
			</a>
		</th>
	</tr>
	</thead>
	<tbody id="wildCardTeamRecordList_table">
	...
	<div class="record_lead">
		...
		<ul class="lead_inner">
					...
					<li>
						<strong class="lead_title">다승 순위</strong>
						<div class="lead_area">
							
								<div class="image"><img src="https://sports-phinf.pstatic.net/player/mlb/default/11251.jpg" width="63" height="79" alt="메릴 켈리" onerror="imageOnError(this);"></div>
							...
							<div class="list">
											...
											<div class="text best">
												<b class="rank_num">1</b>
												<div class="info">
													<span class="name">미치 켈러</span>
													<span class="team">피츠버그</span>
												</div>
												<div class="stat">
													<span>7</span> 승
												</div>
					...
					<li>
						<strong class="lead_title">평균자책 순위</strong>
						<div class="lead_area">
							
								<div class="image"><img src="https://sports-phinf.pstatic.net/player/mlb/default/12120.jpg" width="63" height="79" alt="브라이스 엘더" onerror="imageOnError(this);"></div>
							...
							<div class="list">
											...
											<div class="text best">
												<b class="rank_num">1</b>
												<div class="info">
													<span class="name">브라이스 엘더</span>
													<span class="team">애틀랜타</span>
												</div>
												<div class="stat">
													<span>2.26</span>
												</div>
											...
											<div class="text ">
												...
												<div class="info">
													<span class="name">마커스 스트로먼</span>
													<span class="team">시카고C</span>
												</div>
												<div class="stat">
													<span>2.39</span>
												</div>
					...
					<li>
						<strong class="lead_title">탈삼진 순위</strong>
						<div class="lead_area">
							
								<div class="image"><img src="https://sports-phinf.pstatic.net/player/mlb/default/312281.jpg" width="63" height="79" alt="스펜서 스트라이더" onerror="imageOnError(this);"></div>
							...
							<div class="list">
											...
											<div class="text best">
												<b class="rank_num">1</b>
												<div class="info">
													<span class="name">스펜서 스트라이더</span>
													<span class="team">애틀랜타</span>
												</div>
												<div class="stat">
													<span>113</span>
					...
					<li>
						<strong class="lead_title">세이브 순위</strong>
						<div class="lead_area">
							
								<div class="image"><img src="https://sports-phinf.pstatic.net/player/mlb/default/11536.jpg" width="63" height="79" alt="카밀로 도발" onerror="imageOnError(this);"></div>
							...
							<div class="list">
											...
											<div class="text best">
												<b class="rank_num">1</b>
												<div class="info">
													<span class="name">카밀로 도발</span>
													<span class="team">샌프란시스코</span>
												</div>
												<div class="stat">
													<span>15</span>
												</div>
		...
		<ul class="lead_inner">
					...
					<li>
						<strong class="lead_title">타율 순위</strong>
						<div class="lead_area">
							
								<div class="image"><img src="https://sports-phinf.pstatic.net/player/mlb/default/11221.jpg" width="63" height="79" alt="루이스 아라에즈" onerror="imageOnError(this);"></div>
							...
							<div class="list">
											...
											<div class="text best">
												<b class="rank_num">1</b>
												<div class="info">
													<span class="name">루이스 아라에즈</span>
													<span class="team">마이애미</span>
												</div>
												<div class="stat">
													<span>0.403</span>
												</div>
											...
											<div class="text ">
												<b class="rank_num">3</b>
												<div class="info">
													<span class="name">프레디 프리먼</span>
													<span class="team">LAD</span>
												</div>
												<div class="stat">
													<span>0.328</span>
												</div>
					...
					<li>
						<strong class="lead_title">타점 순위</strong>
						<div class="lead_area">
							
								<div class="image"><img src="https://sports-phinf.pstatic.net/player/mlb/default/10918.jpg" width="63" height="79" alt="피트 알론소" onerror="imageOnError(this);"></div>
							...
							<div class="list">
											...
											<div class="text best">
												<b class="rank_num">1</b>
												<div class="info">
													<span class="name">피트 알론소</span>
													<span class="team">뉴욕M</span>
												</div>
												<div class="stat">
													<span>49</span>
												</div>
											...
											<div class="text ">
												<b class="rank_num">2</b>
												<div class="info">
													<span class="name">놀란 고먼</span>
													<span class="team">세인트루이스</span>
												</div>
												<div class="stat">
													<span>44</span>
												</div>
					...
					<li>
						<strong class="lead_title">홈런 순위</strong>
						<div class="lead_area">
					...
					<li>
						<strong class="lead_title">도루 순위</strong>
						<div class="lead_area">
							
								<div class="image"><img src="https://sports-phinf.pstatic.net/player/mlb/default/10646.jpg" width="63" height="79" alt="로날드 아쿠나" onerror="imageOnError(this);"></div>
	...
	<div class="record_sub_title">
		<h4 class="record_h" id="sortPlayerTitle">투수 순위</h4>
	</div>
	<div class="toggle_tab align_right">
		<div class="inner">
			<a href="javascript:changePlayerType('pitcher');" class="selected" id="pitcherBtn"><span>투수 순위</span></a>
			<a href="javascript:changePlayerType('batter');" id="batterBtn"><span>타자 순위</span></a>
		</div>
	</div>
	...
	<div class="record_tbl double_line exception" id="pitcherTable">
		<table>
			<caption>투수 순위</caption>
			<colgroup>
				<col width="45">
				<col width="*">
				<col width="68">
			...
			<tr>
				...
				<th scope="col" id="pitcher_th_W">
					<a href="javaScript:sortByPlayerColumn('W', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_W">승</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_L">
					<a href="javaScript:sortByPlayerColumn('L', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_L">패</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_SV">
					<a href="javaScript:sortByPlayerColumn('SV', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_SV">세이브</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_ERA" class="selected">
					<a href="javaScript:sortByPlayerColumn('ERA', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_ERA">평균자책</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_SO">
					<a href="javaScript:sortByPlayerColumn('SO', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_SO">탈삼진</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_HLD">
					<a href="javaScript:sortByPlayerColumn('HLD', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_HLD">홀드</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_IP">
					<a href="javaScript:sortByPlayerColumn('IP', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_IP">이닝</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_H">
					<a href="javaScript:sortByPlayerColumn('H', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_H">피안타</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_HR">
					<a href="javaScript:sortByPlayerColumn('HR', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_HR">피홈런</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_BB">
					<a href="javaScript:sortByPlayerColumn('BB', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_BB">볼넷</strong>
					</a>
				</th>
				<th scope="col" id="pitcher_th_G">
					<a href="javaScript:sortByPlayerColumn('G', 'pitcher');" class="inner">
						<strong class="sort" id="pitcher_G">경기수</strong>
					</a>
				</th>
			</tr>
			</thead>
			<tbody id="pitcherRecordTable">
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/AT.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">브라이스 엘더</span>
							<span class="team">애틀랜타</span>
						</div>
					</td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/CC.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">마커스 스트로먼</span>
							<span class="team">시카고C</span>
						</div>
					</td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/SF.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">알렉스 콥</span>
							<span class="team">샌프란시스코</span>
						</div>
					</td>
					<td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/AZ.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">잭 갈렌</span>
							<span class="team">애리조나</span>
						</div>
					</td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/MO.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">조시아 그레이</span>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/SD.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">마이클 와카</span>
							<span class="team">샌디에이고</span>
						</div>
					</td>
					<td>
						<div class="inner">
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/LA.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">클레이튼 커쇼</span>
							<span class="team">LAD</span>
						</div>
					</td>
					<td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/MI.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">코빈 번스</span>
							<span class="team">밀워키</span>
						</div>
					</td>
					<td>
						<div class="inner">
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/PI.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">미치 켈러</span>
							<span class="team">피츠버그</span>
						</div>
					</td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/SL.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">마일스 마이콜라스</span>
							<span class="team">세인트루이스</span>
						</div>
					</td>
					<td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/FL.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">헤수스 루자르도</span>
							<span class="team">마이애미</span>
						</div>
					</td>
					<td>
				...
				<tr>
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/CI.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">헌터 그린</span>
							<span class="team">신시내티</span>
						</div>
					</td>
					<td>
				...
				<tr class="last">
					...
					<td class="align_l">
						<div class="inner">
							<span class="emblem"><img width="25" height="25" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/mlb/default/SF.png&amp;type=f25_25&amp;refresh=1" alt="구단 로고" onerror="imageOnError(this);"></span>
							<span class="name">앤서니 데스클라파니</span>
							<span class="team">샌프란시스코</span>
						</div>
					</td>
					<td>
	...
	<div class="record_tbl double_line exception" style="display: none" id="batterTable">
		<table>
			<caption>타자 순위</caption>
			<colgroup>
				<col width="45">
				<col width="">
				<col width="56">
			...
			<tr>
				...
				<th scope="col" id="batter_th_AB">
					<a href="javaScript:sortByPlayerColumn('AB', 'batter');" class="inner">
						<strong class="sort" id="batter_AB">타수</strong>
					</a>
				</th>
				<th scope="col" class="selected" id="batter_th_AVG">
					<a href="javaScript:sortByPlayerColumn('AVG', 'batter');" class="inner">
						<strong class="sort" id="batter_AVG">타율</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_RBI">
					<a href="javaScript:sortByPlayerColumn('RBI', 'batter');" class="inner">
						<strong class="sort" id="batter_RBI">타점</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_HR">
					<a href="javaScript:sortByPlayerColumn('HR', 'batter');" class="inner">
						<strong class="sort" id="batter_HR">홈런</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_SB">
					<a href="javaScript:sortByPlayerColumn('SB', 'batter');" class="inner">
						<strong class="sort" id="batter_SB">도루</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_R">
					<a href="javaScript:sortByPlayerColumn('R', 'batter');" class="inner">
						<strong class="sort" id="batter_R">득점</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_H">
					<a href="javaScript:sortByPlayerColumn('H', 'batter');" class="inner">
						<strong class="sort" id="batter_H">안타</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_H2B">
					<a href="javaScript:sortByPlayerColumn('H2B', 'batter');" class="inner">
						<strong class="sort" id="batter_H2B">2루타</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_H3B">
					<a href="javaScript:sortByPlayerColumn('H3B', 'batter');" class="inner">
						<strong class="sort" id="batter_H2B">3루타</strong>
					</a>
				</th>
				
					
						<th scope="col" id="batter_th_BB">
							<a href="javaScript:sortByPlayerColumn('BB', 'batter');" class="inner">
								<strong class="sort" id="batter_BB">볼넷</strong>
							</a>
						</th>
					
					
				
				<th scope="col" id="batter_th_SO">
					<a href="javaScript:sortByPlayerColumn('SO', 'batter');" class="inner">
						<strong class="sort" id="batter_SO">삼진</strong>
					</a>
				</th>
				
				<th scope="col" id="batter_th_OBP">
					<a href="javaScript:sortByPlayerColumn('OBP', 'batter');" class="inner">
						<strong class="sort" id="batter_OBP">출루율</strong>
					</a>
				</th>
				<th scope="col" id="batter_th_G">
					<a href="javaScript:sortByPlayerColumn('G', 'batter');" class="inner">
						<strong class="sort" id="batter_G">경기수</strong>
					</a>
				</th>
			</tr>
			</thead>
			<tbody id="batterRecordTable">
			</tbody>
		</table>
	</div>
	<script>
...
<div class="record_info">
    ...
    <ul class="p_noti">
                ...
                <li>※ 와일드카드 4위팀부터의 게임차는 3위대비 기준 표시됩니다.</li>
                <li>※ 순위표는 MLB.COM 기준으로, 매일 오후 업데이트 됩니다.</li>
                <li>※ 해외야구 순위는 시즌 종료 시 전년도 순위 기준으로 노출되며, 개막일 이후 새 시즌 순위표로 노출됩니다..</li>
