...
<meta property="og:url"
	content="https://sports.news.naver.com/kbaseball/news/index.nhn">



<title>뉴스, 야구 : 네이버 스포츠</title>
<link rel="stylesheet" type="text/css"
	href="${CP}/resources/css/Baseball_nsports.css">
...
<script></script>
<scrip> </script> <script></script> <script></script> <script></script>
</head>
	...
	<div id="wrap">
		...
		<header id="header" class="sports_header_pc">
			<div class="sports_gnb" role="banner">
				...
				<h1 class="logo_area">
					<a href="https://www.naver.com" class="logo_naver"
						...
						class="blind">네이버</span></a> <a href="우리 처음 시작하는 주소를 넣으면됨."
						class="logo_sports"
						...
						<ul class="gnb_lst" id="gnb_lst" style="display: block;">
										...
										<div class="gnb_txt_area">
											<p class="gnb_account">
												<span class="gnb_name" id="gnb_name2"><a
													...
													class="gnb_btn_login"
													href="https://nid.naver.com/nidlogin.logout?returl=https%3A%2F%2Fsports.news.naver.com%2Fkbaseball%2Fnews%2Findex"
							...
							<li class="gnb_service_li" id="gnb_service_layer"
								...
								<iframe id="gnb_svc_more_iframe" title="빈 프레임"
									class="gnb_pad_lyr" name="padding" width="0" height="0"
									scrolling="no" frameborder="0"
									style="display: none; top: 55px; right: 10px; width: 295px; height: 385px; opacity: 0;"></iframe>
							</li>
						</ul>
					</div>
				</div>
			...
			<nav class="sports_lnb" role="navigation" id="_sports_lnb_menu">
				...
				<ul id="lnb_list" class="lnb_list" role="menubar">
					...
					<!-- 					<li class="lnb_item" role="presentation"><a
						...
						onclick="clickcr(this, 'LNB.worldbaseball', 'worldbaseball', '', event); ; ">해외야구</a>
					</li> -->

					<!-- 					<li class="lnb_item" role="presentation"><a
						href="/wfootball/index" class="link_lnb" role="menuitem"
						onclick="clickcr(this, 'LNB.worldfootball', 'worldfootball', '', event); ; ">해외축구</a>
					</li> -->

					<!-- 					<li class="lnb_item" role="presentation"><a
						href="/general/index" class="link_lnb" role="menuitem"
						onclick="clickcr(this, 'LNB.general', 'general', '', event); ; ">일반</a>
					</li> -->

					<!-- 					<li class="lnb_item" role="presentation"><a
						href="https://game.naver.com/esports" class="link_lnb"
						role="menuitem"
						onclick="clickcr(this, 'LNB.esports', 'esports', '', event); ; ">e스포츠</a>
					</li> -->

					<!-- 					<li class="lnb_item" role="presentation"><a
						href="https://m.sports.naver.com/column/storyteller"
						class="link_lnb" role="menuitem"
						onclick="clickcr(this, 'LNB.column', 'column', '', event);  javascript:lnbOpenPopup(this.href); return false; ; ">연재</a>
					</li> -->

					<!-- 					<li class="lnb_item" role="presentation"><a
						href="/scoreboard/index" class="link_lnb" role="menuitem"
						onclick="clickcr(this, 'LNB.scoreboard', 'scoreboard', '', event); ; ">오늘의
							경기</a></li> -->
					<!-- 
					<li class="lnb_item" role="presentation"><a
						href="/ranking/index" class="link_lnb" role="menuitem"
						onclick="clickcr(this, 'LNB.ranking', 'ranking', '', event); ; ">랭킹</a>
					</li>
				</ul> -->
			</nav>
			<nav class="sports_lnb_sub">
				<ul id="lnb_sub_list" class="lnb_sub_list" role="menubar">
					...
					<!-- 					<li class="lnb_sub_item " role="presentation"><a
						href="/kbaseball/vod/index" class="link_lnb_sub" role="menuitem"
						onclick="clickcr(this, 'LNB.video', 'video', '', event); "> <span
							class="menu">영상</span>
					</a></li> -->
					<!-- 					<li class="lnb_sub_item " role="presentation"><a
						href="/photocenter/albumList?category=kbo" class="link_lnb_sub"
						role="menuitem"
					...
					<!-- 					<li class="lnb_sub_item " role="presentation"><a
						href="/kbaseball/column/columnistList" class="link_lnb_sub"
						role="menuitem"
						onclick="clickcr(this, 'LNB.issue', 'issue', '', event); "> <span
							class="menu">구단/협회</span>
					</a></li> -->
					<!-- 					<li class="lnb_sub_item " role="presentation"><a
						href="https://m.sports.naver.com/kbollect" class="link_lnb_sub"
		...
		<div id="container">
				...
				<div class="news_wrap">
						...
						<div class="content_area">
							<div class="tab_event">
								<ul class="list" id="_sectionList">
									<li class="selected" data-id="kbaseball"><a href="#"
										onclick="clickcr(this, 'nwl.league', '', '', event);"><span
											class="menu">야구 전체</span></a></li>
									...
									<li data-id="baseballetc"><a href="#"
										onclick="clickcr(this, 'nwl.league', '', '', event);"><span
											class="menu">야구 일반</span></a></li>
							...
							<div class="news_lnb">
								<ul class="sort" id="_sortTypeList">
									...
									<li data-id="latest" class="selected"><a href="#"
										onclick="clickcr(this, 'nwl.newest', '', '', event);"><span>최신순</span></a>
									</li>

									<li data-id="popular"><a href="#"
										onclick="clickcr(this, 'nwl.popular', '', '', event);"><span>인기순</span></a>
									</li>

									<li data-id="team" class="toggle" style=""><a href="#"><span>구단별</span></a>
									</li>

								</ul>
								<div class="option">
									<a href="#" class="button" id="_exceptPhotoBtn"
							...
							<div class="paginate" id="_pageList" style="">
								...
								<a href="#" data-id="2" onclick="clickcr">2</a> <a
									...
									href="#" data-id="5"
									onclick="clickcr(this, 'nwl.paging', '', '', event);">5</a> <a
									href="#" data-id="6"
									onclick="clickcr(this, 'nwl.paging', '', '', event);">6</a> <a
									href="#" data-id="7"
									onclick="clickcr(this, 'nwl.paging', '', '', event);">7</a> <a
									href="#" data-id="8"
									onclick="clickcr(this, 'nwl.paging', '', '', event);">8</a> <a
									href="#" data-id="9"
							...
							<div class="paginate_day" id="_bottomDateList">
								<a href="#" class="prev _arr"
									onclick="clickcr(this, 'nwl.date', '', '', event);"><span
									class="blind">이전</span></a>
								<div class="inner">
									<a href="#" data-id="20230605"
										onclick="clickcr(this, 'nwl.date', '', '', event);"><span>06.05</span>(월)</a>
									<a href="#" data-id="20230606"
										onclick="clickcr(this, 'nwl.date', '', '', event);"><span>06.06</span>(화)</a>
									<a href="#" data-id="20230607"
										onclick="clickcr(this, 'nwl.date', '', '', event);"><span>06.07</span>(수)</a>
									<a href="#" data-id="20230608"
										onclick="clickcr(this, 'nwl.date', '', '', event);"><span>06.08</span>(목)</a>
									<a href="#" data-id="20230609" class="selected"
										onclick="clickcr(this, 'nwl.date', '', '', event);"><span>06.09</span>(금)</a>
								</div>
					...
					<div id="news_aside" class="aside">
						<div id="section_end_right_banner" class="aside_da2">
							<div
								style="width: 100%; height: auto; margin: 0px auto; line-height: 0;">
								<iframe id="section_end_right_banner_tgtLREC" frameborder="no"
									scrolling="no" tabindex="0" name="" title="AD"
									style="width: 100%; height: 250px; visibility: inherit; border: 0px; vertical-align: bottom;"></iframe>
							</div>
						</div>
						...
						<div id="news_best" class="aside_inner">
							<div class="aside_head">
								...
								<button type="button" class="button_info_layer"
									aria-describedby="_wa_layer_message">
									<span class="blind">도움말</span>
								</button>
								<div class="news_info_layer">


									<p id="_wa_layer_message" role="tooltip">최근 한 달 기사 중 오후 2시
										~ 3시까지 집계한 조회 수입니다. 총 누적과 다를 수 있습니다.</p>
							...
							<div class="aside_rank_news">
								...
								<div id="_ranking_news_tab_selector" class="aside_tab2">
									<div class="inner">
										<a href="#" class="selected" id="_ranking_news_tab_0"
											data-select-num="0"><span>야구</span></a>
										<!-- 										<a href="#"
								...
								<div id="news_vod" class="aside_inner">
									...
									<div class="aside_vod_best2">
										<ul class="aside_vod_list2">
												...
												title="${video[0].title}">
													<div class="thmb">
														<b class="rank_num">1</b> <span class="mask"></span> <img
															...
															src="https://imgnews.pstatic.net/image/117/2023/05/25/202305251241528605_1_20230525160004727.jpg?type=w648"
															class="imageLazyLoad"
															lazy-src="https://imgnews.pstatic.net/image/117/2023/05/25/202305251241528605_1_20230525160004727.jpg?type=w648"
											...
											<li class="vod_li"><a
												href="/video?category=kbo&amp;id=1078043"
												onclick="clickcr(this, 'aec*b.video', '', '', event);"
												title="직장에 아들이 놀러 왔다 #ShortForm">
													<div class="thmb">
														...
														<img width="110" height="64"
															src="https://dthumb-phinf.pstatic.net/?twidth=110&amp;theight=64&amp;opts=12&amp;qlt=95&amp;src=https://sports-phinf.pstatic.net/20230608_30/1686228795066kllNi_JPEG/%C0%CC%C1%A4%C8%C4.jpg"
															class="imageLazyLoad"
															lazy-src="https://dthumb-phinf.pstatic.net/?twidth=110&amp;theight=64&amp;opts=12&amp;qlt=95&amp;src=https://sports-phinf.pstatic.net/20230608_30/1686228795066kllNi_JPEG/%C0%CC%C1%A4%C8%C4.jpg"
															alt="" onerror="imageOnError(this);">


													</div>
													<div class="text">
														<span class="title"><span>직장에 아들이 놀러 왔다
																#ShortForm</span></span>
														<div class="info">
								...
								<div id="ranking1" class="aside_inner">
									...
									<div class="aside_rank_player">
										<div class="aside_tab2">
											<div class="inner">
												<a
													onmouseover="javascript:changePlayerRankingTab('kbo', 0, 4);"
													id="playerRankingTab_kbo_0" class="selected"><span>타율</span></a>
												<a
													onmouseover="javascript:changePlayerRankingTab('kbo', 1, 4);"
													id="playerRankingTab_kbo_1" class=""><span>홈런</span></a> <a
													onmouseover="javascript:changePlayerRankingTab('kbo', 2, 4);"
													id="playerRankingTab_kbo_2" class=""><span>다승</span></a> <a
													onmouseover="javascript:changePlayerRankingTab('kbo', 3, 4);"
													id="playerRankingTab_kbo_3" style="width: 78px" class=""><span>평균자책</span></a>
											</div>
										</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="김선빈">
													</div>
													<div class="info">
														<span class="name">김선빈</span> <span class="team">KIA</span>
													</div>
													<div class="stat">
														<span>0.321</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="에레디아">
													</div>
													<div class="info">
														<span class="name">에레디아</span> <span class="team">SSG</span>
													</div>
													<div class="stat">
														<span>0.318</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="최형우">
													</div>
													<div class="info">
														<span class="name">최형우</span> <span class="team">KIA</span>
													</div>
													<div class="stat">
														<span>0.318</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="손아섭">
													</div>
													<div class="info">
														<span class="name">손아섭</span> <span class="team">NC</span>
													</div>
													<div class="stat">
														<span>0.318</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="양의지">
													</div>
													<div class="info">
														<span class="name">양의지</span> <span class="team">두산</span>
													</div>
													<div class="stat">
														<span>0.317</span>
													</div>
										...
										<ul class="list" id="playerRankingList_kbo_1"
											style="display: none;">
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="박동원">
													</div>
													<div class="info">
														<span class="name">박동원</span> <span class="team">LG</span>
													</div>
													<div class="stat">
														<span>14</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="최정">
													</div>
													<div class="info">
														<span class="name">최정</span> <span class="team">SSG</span>
													</div>
													<div class="stat">
														<span>11</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="최주환">
													</div>
													<div class="info">
														<span class="name">최주환</span> <span class="team">SSG</span>
													</div>
													<div class="stat">
														<span>10</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="로하스">
													</div>
													<div class="info">
														<span class="name">로하스</span> <span class="team">두산</span>
													</div>
													<div class="stat">
														<span>10</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="노시환">
													</div>
													<div class="info">
														<span class="name">노시환</span> <span class="team">한화</span>
													</div>
													<div class="stat">
														<span>9</span>
													</div>
										...
										<ul class="list" id="playerRankingList_kbo_2"
											style="display: none;">
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="페디">
													</div>
													<div class="info">
														<span class="name">페디</span> <span class="team">NC</span>
													</div>
													<div class="stat">
														<span>9</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="플럿코">
													</div>
													<div class="info">
														<span class="name">플럿코</span> <span class="team">LG</span>
													</div>
													<div class="stat">
														<span>8</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="알칸타라">
													</div>
													<div class="info">
														<span class="name">알칸타라</span> <span class="team">두산</span>
													</div>
													<div class="stat">
														<span>7</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="켈리">
													</div>
													<div class="info">
														<span class="name">켈리</span> <span class="team">LG</span>
													</div>
													<div class="stat">
														<span>6</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="벤자민">
													</div>
													<div class="info">
														<span class="name">벤자민</span> <span class="team">KT</span>
													</div>
													<div class="stat">
														<span>6</span>
													</div>
										...
										<ul class="list" id="playerRankingList_kbo_3"
											style="display: none;">
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="안우진">
													</div>
													<div class="info">
														<span class="name">안우진</span> <span class="team">키움</span>
													</div>
													<div class="stat">
														<span>1.87</span>
													</div>
												...
												<div class="inner">
													...
													<div class="image">
														<img
															...
															onerror="imageOnError(this);" alt="나균안">
													</div>
													<div class="info">
														<span class="name">나균안</span> <span class="team">롯데</span>
													</div>
													<div class="stat">
														<span>2.55</span>
													</div>
								...
								<div class="aside_inner" id="right_big_banner_0" style="">
									<div class="aside_magazines">
										...
										<div class="thmb">
											<a href="https://tv.naver.com/olympicchannel" target="_blank"
												onclick="clickcr(this, 'aec*d.banner', '', '', event);">
												<img width="300"
							...
							<div class="aside_inner aside_shopping aside_shopping_v2">
								<div class="aside_head">
									<h3 class="title">
										<strong>야구</strong> 네이버 쇼핑
									</h3>
									<div class="shopping_paginated" id="_shoppingPageArea">
										<span class="pa_num"><em id="_shoppingPageNum">2</em> /
											2</span> <span id="_shoppingDisablePrevBtn" class="nav prev"
											style="display: none;"><span>이전 없음</span></span> <a
											id="_shoppingEnablePrevBtn" href="#" class="nav prev"
											onclick="clickcr(this, 'aec*h.prev', '', '', event);"><span>이전</span></a>
										<a id="_shoppingEnableNextBtn" href="#" class="nav next"
											onclick="clickcr(this, 'aec*h.next', '', '', event);"
											style="display: none;"><span>다음</span></a> <span
											id="_shoppingDisableNextBtn" class="nav next" style=""><span>다음
												없음</span></span>
									</div>
								</div>
								<div class="aside_shopping_ct">
									...
									<ul class="list" id="_shoppingArea_0" style="display: none;">
										...
										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/3743355488"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="정식 규격<br>프로스펙스 야구공" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>2,400</span>원</strong>
												</div> <span class="text">정식 규격<br>프로스펙스 야구공
											</span>
										</a></li>

										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/4947739797"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="더욱 새로워진<br>트리니티 야구헬멧" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>39,000</span>원</strong>
												</div> <span class="text">더욱 새로워진<br>트리니티 야구헬멧
											</span>
										</a></li>
										...
										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/8471894041"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="뛰어난 내구성<br>양가죽 배팅 장갑" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>50,000</span>원</strong>
												</div> <span class="text">뛰어난 내구성<br>양가죽 배팅 장갑
											</span>
										</a></li>


										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/2931186859"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="아크 구조 채용<br>미즈노 인조잔디화" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>39,900</span>원</strong>
												</div> <span class="text">아크 구조 채용<br>미즈노 인조잔디화
											</span>
										</a></li>
									...
									<ul class="list" id="_shoppingArea_1" style="">
										...
										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/7721693558"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="3단계 압박<br>노멀라이프 보호대" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>17,900</span>원</strong>
												</div> <span class="text">3단계 압박<br>노멀라이프 보호대
											</span>
										</a></li>
										...
										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/8421471613"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="가벼운 착용감<br>팔꿈치 보호대" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>10,800</span>원</strong>
												</div> <span class="text">가벼운 착용감<br>팔꿈치 보호대
											</span>
										</a></li>
										...
										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/5326346486"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="3가지 모드<br>뱀부 클래식 랜턴" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>49,000</span>원</strong>
												</div> <span class="text">3가지 모드<br>뱀부 클래식 랜턴
											</span>
										</a></li>
										...
										<li class="type1"><a
											href="https://shopping.naver.com/outlink/itemdetail/8347113788"
											onclick="clickcr(this, 'aec*h.goods', '', '', event);">
												<div class="thmb">
													<img width="126" height="160"
														...
														alt="좋은 퀄리티<br>국산 혼무시 100g" onerror="imageOnError(this);">
													<span class="mask"></span>
												</div>
												<div class="price_wrap">
													<span class="blind">가격 : </span><strong class="price"><span>13,500</span>원</strong>
												</div> <span class="text">좋은 퀄리티<br>국산 혼무시 100g
											</span>
										</a></li>
			...
			<script type="text/javascript"
				src="https://ssl.pstatic.net/static.sports/resources/pc/8088/66/88/664600/js/src/changeUrl.js"
