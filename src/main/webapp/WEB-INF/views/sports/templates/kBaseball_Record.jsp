...
<div class="date_select_nav type_year_month">
    ...
    <div class="select_box_area type_date">
       ...
       -->
        ...
        <button class="btn_move_date prev" type="button"><span class="blind">이전 시즌으로 이동</span></button>
        ...
        <tbody id="regularTeamRecordList_table">
		    <c:forEach var="record" items="${records}" varStatus="loop">
		        <tr>
		            ...
		            <td class="tm">
		                <div>
		                    <span class="emblem"><img src="${record.logo}" width="25" height="25" alt="구단로고" onerror="imageOnError(this);"></span>
		                    <span>${record.hname}</span>
		                </div>
		            </td>
		            <td style="text-align: left; padding-left: 2.5em;"><span>${record.hscore}</span></td>
					<td style="text-align: left; padding-left: 2.5em;"><span>${record.win}</span></td>
					<td style="text-align: left; padding-left: 2.5em;"><span>${record.lose}</span></td>
					<td style="text-align: left; padding-left: 2.5em;"><span>${record.draw}</span></td>
					<td style="text-align: left; padding-left: 2.5em;"><strong>${record.winrate}</strong></td>
		        </tr>
		    </c:forEach>
		</tbody>
    </table>
      ...
      <table cellspacing="0" cellpadding="0">
        ...
        <tbody>
            <c:forEach var="tusus" items="${tusus}" varStatus="loop">
	       		<tr class="dv">
	       	  <th>
	       	    <strong class="high">${loop.count}</strong>
	       	  </th>
	       	  <td class="ply">
	       	    <div>
	       	  ...
	       	  <td>
	       	    <span>${tusus.eravg}</span> 
	       	  </td>
	       	  <td>
	       	    <span>${tusus.played}</span>
	       	  </td>
	       	  <td>
	       		    <span>${tusus.inning}</span>
	       		  </td>
	       		  <td>
	       		    <span>${tusus.win}</span>
	       		  </td>
	       		  <td>
	       		    <span>${tusus.lose}</span>
	       		  </td>
	       		  <td>
	       		    <span>${tusus.save}</span>
	       		  </td>
	       		  <td>
	       		    <span>${tusus.hold}</span>
	       		  </td>
	       		  <td>
	       		    <span>${tusus.k}</span>
	       		  </td>
	       		  ...
	       		  <td>
	       		    <span>${tusus.ball4}</span>
	       		  </td>
	       		  <td>
	       		    <span>${tusus.bb}</span>
	       		  </td>
	       		  <td>
	       		    <span>${tusus.wper}</span>
	       		  </td>
	       		</tr>
			</c:forEach>
        </tbody>
...
<div class="tit_box2">
  <div class="tab_event">
    <ul class="list" id="_playerTypeList">
      <li class="selected" data-player-type-id="pitcher"><a href="#"><span class="menu">타자 순위<span class="blind">선택됨</span></span></a></li>
    </ul>
  </div>
</div>  
    

  <div id="_batterRecord" class="tbl_box hitter tbl_paging _playerRecordDiv">
      ...
      <table cellspacing="0" cellpadding="0">
        ...
        <tbody>
            <c:forEach var="tajas" items="${tajas}" varStatus="loop">
              ...
              <td>
                <span>${tajas.played}</span>
              </td>
              <td>
                    <span>${tajas.hits}</span>
                  </td>
                  <td>
                    <span>${tajas.safety}</span>
                  </td>
                  <td>
                    <span>${tajas.b2}</span>
                  </td>
                  ...
                  <td>
                    <span>${tajas.score}</span>
                  </td>
                  <td>
                    <span>${tajas.steal}</span>
                  </td>
                  <td>
                    <span>${tajas.ball4}</span>
                  </td>
                  <td>
                    <span>${tajas.k}</span>
                  </td>
...
<div class="sports_notice">
  ...
  <a href="https://blog.naver.com/naver_sports/223118608681" class="link_notice" target="_blank" onclick="clickcr(this, 'not.noti', '1466402863231', '', event);">스포츠 TV중계 편성 - 6/5(월)~6/12(월)</a>
    ...
    <div class="sports_info">
      ...
      <p class="footer_copyright">본 콘텐츠의 저작권은 민윤홍 또는 네이버에 있으며, 이를 무단 이용하는 경우 저작권법 등에 따라 법적 책임을 질 수 있습니다.</p>
