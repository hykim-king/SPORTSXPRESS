...
public class Football_MatchVO extends DTO {
	private int	footno		;
	...
	public Football_MatchVO() {

	}


	public Football_MatchVO(int footno, String season, String lname, String time, String location, String hname,
