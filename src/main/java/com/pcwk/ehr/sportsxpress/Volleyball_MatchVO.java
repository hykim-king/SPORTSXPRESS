...
public class Volleyball_MatchVO extends DTO {
	...
	public  Volleyball_MatchVO() {}
	
	
	public Volleyball_MatchVO(int volleyno, String season, String lname, String time, String location, String hname,
