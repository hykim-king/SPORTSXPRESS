...
<html><head>
    ...
    <meta property="og:url" content="sports.news.naver.com/basketball/record/index?category=kbl&amp;tab=team">
...
<div class="rr_wrap">
<div class="tit_box">
    <h4 class="h_team"><span class="blind">팀순위</span></h4>
...
<div class="wnrt_on" id="regularTeamRecordList_ColumnChecker">
  ...
  <div class="tit_box">
    <h4 class="h_head_player"><span class="blind">주요 부문 선두</span></h4>
  </div>
  ...
  <div class="tbl_box p_head">
    <table cellspacing="0" cellpadding="0">
            ...
            <thead>
                <tr>
                    <th><div class=""><strong class="title">득점 평균</strong></div></th>
                    <th><div class=""><strong class="title">도움 평균</strong></div></th>
                    <th><div class=""><strong class="title">리바운드 평균</strong></div></th>
                    <th><div class=""><strong class="title">3점슛 성공</strong></div></th>
                </tr>
            </thead>
            <tbody>
                <tr>
...
<div class="tbl_box type2">
    <table cellspacing="0" cellpadding="0">
        ...
        <thead>
            ...
            <th><div class="gcnt_s"><a href="javaScript:sortByPlayerColumn('gameCount');"><strong id="player_gameCount"><span class="blind">경기수</span></strong></a></div></th>
            <th><div class="score"><a href="javaScript:sortByPlayerColumn('point');"><strong id="player_point" class="sort"><span class="blind">득점</span></strong></a></div></th>
            <th><div class="as"><a href="javaScript:sortByPlayerColumn('assist');"><strong id="player_assist"><span class="blind">AS</span></strong></a></div></th>
            <th><div class="rbd"><a href="javaScript:sortByPlayerColumn('rebound');"><strong id="player_rebound"><span class="blind">리바운드</span></strong></a></div></th>
            <th><div class="stl"><a href="javaScript:sortByPlayerColumn('steal');"><strong id="player_steal"><span class="blind">스틸</span></strong></a></div></th>
            <th><div class="block"><a href="javaScript:sortByPlayerColumn('block');"><strong id="player_block"><span class="blind">블록</span></strong></a></div></th>
            <th><div class="sht_2"><a href="javaScript:sortByPlayerColumn('point2');"><strong id="player_point2"><span class="blind">2점슛</span></strong></a></div></th>
            <th><div class="sht_3"><a href="javaScript:sortByPlayerColumn('point3');"><strong id="player_point3"><span class="blind">3점슛</span></strong></a></div></th>
            <th><div class="sht_f"><a href="javaScript:sortByPlayerColumn('freeThrow');"><strong id="player_freeThrow"><span class="blind">자유투</span></strong></a></div></th>
            <th><div class="sht_2ss"><a href="javaScript:sortByPlayerColumn('point2Rate');"><strong id="player_point2Rate"><span class="blind">2점슛성공</span></strong></a></div></th>
...
<div class="record_info">
    ...
    <ul class="p_noti">
                ...
                <li>※ 농구 순위는 시즌 종료 시 전년도 순위 기준으로 노출되며, 개막일 이후 새 시즌 순위표로 노출됩니다.</li>
