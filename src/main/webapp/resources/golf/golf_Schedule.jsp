...
<head>
  ...
  <meta property="og:title" content="일정/결과: N골프 : 네이버 스포츠">
  ...
  <meta name="description" content="스포츠의 모든 것, 네이버 스포츠와 함께 하세요">
      ...
      <meta property="og:url" content="https://sports.news.naver.com/golf/schedule/index.nhn">
    
  
  <title>일정/결과: N골프 : 네이버 스포츠</title>
...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/golf/schedule/index" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.schedule', 'schedule', '', event); " aria-current="page">
...
<script id="_golfLeaderboardResultTemplate" type="text/x-handlebars-template">

</script>


<script id="_golfScheduleListMediaTemplate" type="text/x-handlebars-template">

</script>



<script id="_golfScheduleListTemplate" type="text/x-handlebars-template">
  ...
  <div id="content">
    <div class="golf_schedule_wrap">
      <ul class="league_tab_list" id="_categoryList">
          ...
          <li class="league_tab_item">
            ...
            <a href="index?category=golf" class="link_tab is_selected" data-category="golf" onclick="clickcr(this, 'date.all', '', '', event);">전체<span class="blind">선택됨</span></a>
          </li>
          ...
          <li class="league_tab_item">
            ...
            <!-- [D] 탭 활성화시 .is_selected 클래스와 <span class="blind">선택됨</span> 요소를 추가해주세요. -->
            <a href="index?category=pga" class="link_tab " data-category="pga" onclick="clickcr(this, 'date.pga', '', '', event);">PGA</a>
          </li>
          ...
          <li class="league_tab_item">
            ...
            <!-- [D] 탭 활성화시 .is_selected 클래스와 <span class="blind">선택됨</span> 요소를 추가해주세요. -->
            <a href="index?category=lpga" class="link_tab " data-category="lpga" onclick="clickcr(this, 'date.lpga', '', '', event);">LPGA</a>
          </li>
          ...
          <li class="league_tab_item">
            ...
            <!-- [D] 탭 활성화시 .is_selected 클래스와 <span class="blind">선택됨</span> 요소를 추가해주세요. -->
            <a href="index?category=kpga" class="link_tab " data-category="kpga" onclick="clickcr(this, 'date.kpga', '', '', event);">KPGA</a>
          </li>
          ...
          <li class="league_tab_item">
            ...
            <!-- [D] 탭 활성화시 .is_selected 클래스와 <span class="blind">선택됨</span> 요소를 추가해주세요. -->
            <a href="index?category=klpga" class="link_tab " data-category="klpga" onclick="clickcr(this, 'date.klpga', '', '', event);">KLPGA</a>
          </li>
          ...
          <li class="league_tab_item">
            ...
            <!-- [D] 탭 활성화시 .is_selected 클래스와 <span class="blind">선택됨</span> 요소를 추가해주세요. -->
            <a href="index?category=golfetc" class="link_tab " data-category="golfetc" onclick="clickcr(this, 'date.etc', '', '', event);">골프 기타</a>
          </li>
        
      </ul>
      <h3 class="blind">리그 일정/결과</h3>
  ...
  <div class="select_box_area type_date">
    <div class="select_box _year_select_box"> <!-- 연도 선택-->
      <!-- [D]
        ul.option_list 가 닫혀있다면 aria-expanded="false"
        ul.option_list 가 열려있다면 aria-expanded="true" 로 적용 해 주세요.
       -->
      <button class="btn_toggle" id="_currentYearButton" type="button" aria-haspopup="listbox" aria-expanded="false" aria-label="연도 선택">
      ...
      <ul class="option_list" role="listbox">
        <!-- [D] 선택된 button.btn_option 에 aria-selected="true" 를 적용 해 주세요. -->
        <!-- [D] 비활성화 되어야 하는 button.btn_option 에 disabled 속성을 추가 해 주세요. -->
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="true" data-year="2023">2023</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2022">2022</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2021">2021</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2020">2020</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2019">2019</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2018">2018</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2017">2017</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2016">2016</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2015">2015</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2014">2014</button>
        </li>
        <li class="list" role="presentation">
          <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2013">2013</button>
        </li>
      </ul>
    </div>
    <div class="select_box _month_select_box"> <!-- 월 선택-->
      ...
      <ul class="option_list" role="listbox">
        <!-- [D] 선택된 날짜의 button.btn_date 에 aria-selected="true" 를 적용 해 주세요. -->
        <!-- [D] 비활성화 되어야 하는 button.btn_date 에 disabled 속성을 추가 해 주세요. -->
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="01">01</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="02">02</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="03">03</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="04">04</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="05">05</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="true" data-year="2023" data-month="06">06</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="07">07</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="08">08</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="09">09</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="10">10</button>
            </li>
            <li class="list" role="presentation">
              <button class="btn_option" type="button" role="option" onclick="clickcr(this, 'date.move', '', '', event);" aria-selected="false" data-year="2023" data-month="11">11</button>
            </li>
      </ul>
    </div>
    <!-- [D] 비활성화 되어야 하는 button.btn_move_date 에 disabled 속성을 추가 해 주세요. -->
    <button class="btn_move_date prev" type="button" onclick="clickcr(this, 'sch.prevmonth', '', '', event);" data-year="2023" data-month="05"><span class="blind">이전 달로 이동</span></button>
    <button class="btn_move_date next" type="button" onclick="clickcr(this, 'sch.nextmonth', '', '', event);" data-year="2023" data-month="07"><span class="blind">다음 달로 이동</span></button>
  </div>
  <div class="now_date_area">
    <button id="_currentDate" class="btn_now_date" type="button" onclick="clickcr(this, 'date.today', '', '', event);">현재<span class="blind">날짜로 이동</span></button>
  </div>
    ...
    <li class="schedule_item" data-game-id="kpga202311000010M">
      ...
      <div class="schedule_info">
        ...
        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/kpga202311000010M/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
      
      
        <div class="schedule_media">
          <div class="thumbnail_area">
            <!-- [D] 라이브 링크 아닌 영상 링크 일 때, 아래 요소(.icon_play) 를 추가해주세요 -->
            <span class="icon_play"><span class="blind">동영상</span></span>
            <img width="110" height="68" src="https://dthumb-phinf.pstatic.net/?src=https://phinf.pstatic.net/tvcast/20230605_120/wzLLs_1685935723796AP0hk_JPEG/ea9d7a9b-0350-11ee-b692-e4434b3678b0_06.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" class="imageLazyLoad" lazy-src="https://dthumb-phinf.pstatic.net/?src=https://phinf.pstatic.net/tvcast/20230605_120/wzLLs_1685935723796AP0hk_JPEG/ea9d7a9b-0350-11ee-b692-e4434b3678b0_06.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" alt="">
          </div>
          <div class="info_area">
            <span class="title">[제13회 데상트코리아 매치플레이]  우승의 환희가 가득했던 결승전 현장!</span>
            <span class="type">인터뷰</span>
          </div>
          <!-- [D] 영상 페이지로 이동 가능할 때, 추가해주세요 -->
          <a href="/video?id=1077178" class="link_area" onclick="clickcr(this, 'date.hl', '', '', event);">
            <span class="blind">경기 영상 보기</span>
          </a>
        </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="lpga203587143">
      ...
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">미즈호 아메리카스 오픈</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
              <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
              <span class="icon_link"><span class="blind">더보기</span></span>
          </span>
        </div>
        ...
        <div class="schedule_media">
          <div class="thumbnail_area">
            <!-- [D] 라이브 링크 아닌 영상 링크 일 때, 아래 요소(.icon_play) 를 추가해주세요 -->
            <span class="icon_play"><span class="blind">동영상</span></span>
            <img width="110" height="68" src="https://dthumb-phinf.pstatic.net/?src=https://phinf.pstatic.net/tvcast/20230604_203/IpoU6_1685873862549Wz6VV_JPEG/dfa5f7cb-02bb-11ee-83da-d4f5ef5906a4_09.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" class="imageLazyLoad" lazy-src="https://dthumb-phinf.pstatic.net/?src=https://phinf.pstatic.net/tvcast/20230604_203/IpoU6_1685873862549Wz6VV_JPEG/dfa5f7cb-02bb-11ee-83da-d4f5ef5906a4_09.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" alt="">
          </div>
          <div class="info_area">
            <span class="title">미즈호아메리카스오픈 3R 마친 고진영 인터뷰</span>
            <span class="type">3R 인터뷰</span>
          </div>
          <!-- [D] 영상 페이지로 이동 가능할 때, 추가해주세요 -->
          <a href="/video?id=1077063" class="link_area" onclick="clickcr(this, 'date.hl', '', '', event);">
            <span class="blind">경기 영상 보기</span>
          </a>
        </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="pga1251853281">
      <div class="schedule_type">
        <span class="date">06.01 - 06.05</span>
        <span class="league">PGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">메모리얼 토너먼트 by Workday</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
              <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
              <span class="icon_link"><span class="blind">더보기</span></span>
        ...
        <!-- result_area -->
            <div class="result_area">
              <span class="winner">우승</span>
              <span class="winner_name">빅토르 호블란</span>
              <span class="winner_score">281타(-7), 71-71-69-70</span>
            </div>
        <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/pga1251853281/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
        ...
        <div class="schedule_media">
          <div class="thumbnail_area">
            <!-- [D] 라이브 링크 아닌 영상 링크 일 때, 아래 요소(.icon_play) 를 추가해주세요 -->
            <span class="icon_play"><span class="blind">동영상</span></span>
            <img width="110" height="68" src="https://dthumb-phinf.pstatic.net/?src=https://phinf.pstatic.net/tvcast/20230604_45/eQW3H_1685839271821GOLqK_JPEG/5b857685-0270-11ee-81e8-80615f0bcf0c_03.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" class="imageLazyLoad" lazy-src="https://dthumb-phinf.pstatic.net/?src=https://phinf.pstatic.net/tvcast/20230604_45/eQW3H_1685839271821GOLqK_JPEG/5b857685-0270-11ee-81e8-80615f0bcf0c_03.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" alt="">
          </div>
          <div class="info_area">
            <span class="title">메모리얼 토너먼트 3라운드 선두로 마친 김시우 인터뷰</span>
            <span class="type">3R 인터뷰</span>
          </div>
          <!-- [D] 영상 페이지로 이동 가능할 때, 추가해주세요 -->
          <a href="/video?id=1077062" class="link_area" onclick="clickcr(this, 'date.hl', '', '', event);">
            <span class="blind">경기 영상 보기</span>
          </a>
        </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="klpga2023060001">
      <div class="schedule_type">
        <span class="date">06.01 - 06.04</span>
      ...
      <div class="schedule_info">
        ...
        <!-- result_area -->
            <div class="result_area">
              <span class="winner">우승</span>
              <span class="winner_name">최혜진</span>
              <span class="winner_score">274타(-14), 69-66-66-73</span>
            </div>
        <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/klpga2023060001/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
        ...
        <div class="schedule_media">
          <div class="thumbnail_area">
            <!-- [D] 라이브 링크 아닌 영상 링크 일 때, 아래 요소(.icon_play) 를 추가해주세요 -->
            <span class="icon_play"><span class="blind">동영상</span></span>
            <img width="110" height="68" src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/20230608_182/1686201617671fqT7a_JPEG/bandicam_2023-06-08_14-19-36-171.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" class="imageLazyLoad" lazy-src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/20230608_182/1686201617671fqT7a_JPEG/bandicam_2023-06-08_14-19-36-171.jpg&amp;type=sports_nf201_113&amp;noimage=sp5" alt="">
          </div>
          <div class="info_area">
            <span class="title">공아 말 좀 잘 듣자..</span>
            <span class="type">4R </span>
          </div>
          <!-- [D] 영상 페이지로 이동 가능할 때, 추가해주세요 -->
          <a href="/video?id=1077894" class="link_area" onclick="clickcr(this, 'date.hl', '', '', event);">
            <span class="blind">경기 영상 보기</span>
          </a>
        </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="20230604GF1">
      <div class="schedule_type">
        <span class="date">06.04</span>
        <span class="league">골프기타</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">색다른 골프 방송 더 라이브 : KLPGA 롯데 오픈</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <div class="schedule_media"></div>
            </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item is_today" data-game-id="kpga202311000012M">
      <div class="schedule_type">
        <span class="date">06.08 - 06.11</span>
        <span class="league">KPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">제66회 KPGA 선수권대회 with A-ONE CC</span>
          <span class="sub_title">
        ...
        <!-- result_area -->
            ...
            <!-- [D] 리더보드 데이터 표기시, .leaderboard 를 추가해주세요 -->
            <div class="leaderboard">
              <ol class="player_list">
        ...
        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/kpga202311000012M/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
    ...
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item is_today" data-game-id="pga750359940">
      <div class="schedule_type">
        <span class="date">06.08 - 06.12</span>
        <span class="league">PGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">RBC 캐나디언 오픈</span>
          <span class="sub_title">
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">오크데일 GCC</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/pga750359940/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
    ...
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item is_today" data-game-id="klpga2023060002">
      <div class="schedule_type">
        <span class="date">06.09 - 06.11</span>
        <span class="league">KLPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">셀트리온 퀸즈 마스터즈</span>
          <span class="sub_title">
            ...
            <div class="leaderboard">
              <ol class="player_list">
                <li class="player_item">
                  <div class="rank"><span class="number">1</span></div>
                  <div class="player">
                    <span class="name">박주영</span>
                    <span class="total type_under"><span class="blind">Total 점수</span>-6</span>
                    <span class="hole"><span class="blind">홀</span></span>
                  </div>
                </li>
                <li class="player_item">
                  <div class="rank"><span class="number">T2</span></div>
                  <div class="player">
                    <span class="name">김희지</span>
                    <span class="total type_under"><span class="blind">Total 점수</span>-5</span>
                    <span class="hole"><span class="blind">홀</span></span>
                  </div>
                  <div class="player">
                    <span class="name">박민지</span>
                    <span class="total type_under"><span class="blind">Total 점수</span>-5</span>
                    <span class="hole"><span class="blind">홀</span></span>
                  </div>
                  <div class="player">
                    <span class="name">이승연</span>
                    <span class="total type_under"><span class="blind">Total 점수</span>-5</span>
                    <span class="hole"><span class="blind">홀</span></span>
                  </div>
                  <div class="player">
                    <span class="name">황유민</span>
                    <span class="total type_under"><span class="blind">Total 점수</span>-5</span>
                    <span class="hole"><span class="blind">홀</span></span>
                  </div>
                </li>
        ...
        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/klpga2023060002/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
        ...
        <div class="schedule_media">
          <div class="thumbnail_area">
            <!-- [D] 영상 링크 아닌 라이브 링크 일 때, 아래 요소(.common_video_live) 를 추가해주세요 -->
            <span class="common_video_live"><span class="blind">라이브</span></span>
            <img width="110" height="68" src="https://sports-phinf.pstatic.net/liveThumbnail/klpga2023060002.jpg?type=f640_360" class="imageLazyLoad" lazy-src="https://sports-phinf.pstatic.net/liveThumbnail/klpga2023060002.jpg?type=f640_360" alt="">
            <span class="blind">라이브</span>
          </div>
          <div class="info_area">
              <span class="title">셀트리온 퀸즈 마스터즈</span>
          </div>
          <!-- [D] 영상 페이지로 이동 가능할 때, 추가해주세요 -->
          <a href="javascript:popUp('/tv/index?category=klpga&amp;gameId=klpga2023060002', 1088, 670);" onclick="clickcr(this, 'scx.tvlive', '', '', event);" class="link_area">
            <span class="blind">경기 중계 보기</span>
          </a>
        </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item is_today" data-game-id="lpga53103111">
      <div class="schedule_type">
        <span class="date">06.09 - 06.12</span>
        <span class="league">LPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">숍라이트 LPGA 클래식</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/lpga53103111/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">$1,750,000</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="kpga202311000014M">
      <div class="schedule_type">
        <span class="date">06.15 - 06.18</span>
        <span class="league">KPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">하나은행 인비테이셔널</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">Chiba Isumi GC</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/kpga202311000014M/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">1,000,000,000원</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="klpga2023060003">
      <div class="schedule_type">
        <span class="date">06.15 - 06.18</span>
        <span class="league">KLPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">DB그룹 제37회 한국여자오픈 골프선수권대회</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">레인보우힐스</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/klpga2023060003/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">1,200,000,000원</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="pga780195245">
      <div class="schedule_type">
        <span class="date">06.15 - 06.19</span>
        <span class="league">PGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">U.S. 오픈</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">더 로스앤젤레스 컨트리 클럽</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/pga780195245/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">$15,000,000</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="lpga1724072164">
      <div class="schedule_type">
        <span class="date">06.15 - 06.19</span>
        <span class="league">LPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">마이어 LPGA 클래식 포 심플리 기브</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">블라이더필드 CC</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/lpga1724072164/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">$2,500,000</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="kpga202311000017M">
      <div class="schedule_type">
        <span class="date">06.22 - 06.25</span>
        <span class="league">KPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">코오롱 제65회 한국오픈</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">우정힐스 CC</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/kpga202311000017M/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">-</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="pga369983227">
      <div class="schedule_type">
        <span class="date">06.22 - 06.26</span>
        <span class="league">PGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">트래블러스 챔피언십</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">TPC 리버 하이랜즈</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/pga369983227/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">$20,000,000</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="lpga895878810">
      <div class="schedule_type">
        <span class="date">06.22 - 06.26</span>
        <span class="league">LPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">KPMG 위민스 PGA 챔피언십</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">Baltusrol Golf Club</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/lpga895878810/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">$9,000,000</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="klpga2023060004">
      <div class="schedule_type">
        <span class="date">06.23 - 06.25</span>
        <span class="league">KLPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">BC카드 · 한경 레이디스컵 2023</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">포천힐스</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/klpga2023060004/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">800,000,000원</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="pga269784143">
      <div class="schedule_type">
        <span class="date">06.29 - 07.03</span>
        <span class="league">PGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">로켓 모기지 클래식</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">디트로이트 GC</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/pga269784143/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
          ...
          <div class="schedule_media">
            <div class="info_area">
              <span class="reward_text">총상금</span>
              <span class="reward_number">$8,800,000</span>
            </div>
          </div>
    </li>
    <!-- [D] 오늘 날짜의 경기인 경우, .is_today 를 추가해주세요. -->
    <li class="schedule_item" data-game-id="klpga2023060005">
      <div class="schedule_type">
        <span class="date">06.30 - 07.02</span>
        <span class="league">KLPGA</span>
      </div>
      <div class="schedule_info">
        <div class="title_area">
          <span class="title">맥콜 · 모나 용평 오픈 with SBS Golf</span>
          <span class="sub_title">
            <!-- 라운드 정보 nR 종료/경기중 추가-->
          </span>
        </div>
        ...
        <!-- result_area -->
          <div class="result_area">
            <span class="location">버치힐</span>
          </div>
                  <!-- //result_area -->

        <!-- [D] 리더보드로 이동 가능할 때, 추가해주세요 -->
          <a href="/game/klpga2023060005/leaderboard" class="link_area" onclick="clickcr(this, 'date.leader', '', '', event);">
            <span class="blind">경기보기</span>
          </a>
      </div> 
