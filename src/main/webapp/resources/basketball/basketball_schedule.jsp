...
<head>
    ...
    <meta property="og:url" content="sports.news.naver.com/basketball/schedule/index?category=kbl">
...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/basketball/schedule/index" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.schedule', 'schedule', '', event); " aria-current="page">
...
<div class="tab_event">
    <ul class="list" id="_categoryList">
            ...
            <li><a href="/schedule/index?category=wkbl" data-category="wkbl"><span class="menu">여자프로농구</span></a></li>
                        ...
                        <script></script>
                        <div id="sch_recent_scoreboard" class="sch_game">
                            
<div class="sch_score kbl_nba">
    <ul class="tab">
        <li class="btn_prev2"><a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230429');return false" title="이전">이전</a></li>
        
            <li>
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230501');">
                    <em>5.01</em>(월)
            ...
            <li>
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230502');">
                    <em>5.02</em>(화)
            ...
            <li>
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230503');">
                    <em>5.03</em>(수)
            ...
            <li>
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230504');">
                    <em>5.04</em>(목)
            ...
            <li>
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230505');">
                    <em>5.05</em>(금)
            ...
            <li>
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230506');">
                    <em>5.06</em>(토)
            ...
            <li class="on">
                <a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('20230507');">
                    <em>5.07</em>(일)
                    
                </a>
            </li>
        
        <li class="btn_next2"><a href="#" onclick="javascript:scoreBoardInstance.setScoreBoard('');" title="다음">다음</a></li>
    </ul>
                ...
                <div class="sch_vs" id="todaySchedule0">
                    ...
                    <div class="inner_lft end">
                        ...
                        <div class="vs_lft">
                            ...
                            <span class="vs_team">안양 KGC</span>
                            <strong class="vs_num">100<span class="vs_bg"></span></strong>
                        </div>
                        <div class="vs_rgt">
                            ...
                            <span class="vs_team">서울 SK</span>
                            <strong class="vs_num">97</strong>
                        </div>
                        <div class="vs_btn">
                                    ...
                                    <a class="btn_rst" href="/game/20230507705541047/record">
                                        ...
                                        <a class="btn_vod" href="https://m.sports.naver.com/basketball/video?category=kbl&amp;gameId=20230507705541047&amp;tab=game&amp;date=2023-05-07&amp;sort=date">
...
<form name="monthlyScheduleForm" id="monthlyScheduleForm" action="/schedule/index" method="get">
  ...
  <input type="hidden" name="category" id="category" value="kbl">
  <input type="hidden" name="year" id="year" value="2023">
  <input type="hidden" name="month" id="month" value="05">
  <input type="hidden" name="teamCode" id="teamCode" value="">
  <input type="hidden" name="date" id="date" value="20230507">
</form>
...
<div class="date_select_nav type_year_month" style="display: block">
  ...
  <div class="select_box_area type_date">
      ...
      <ul class="option_list" role="listbox" id="_yearList">
        ...
        <!-- [D] 비활성회 되어야 하는 button.btn_date 에 disabled 속성을 추가 해 주세요. -->
          ...
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="true" onclick="changeSchedule('2023','05','');">2023</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2022','05','');">2022</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2021','05','');">2021</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2020','05','');">2020</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2019','05','');">2019</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2018','05','');">2018</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2017','05','');">2017</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2016','05','');">2016</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2015','05','');">2015</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2014','05','');">2014</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2013','05','');">2013</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2012','05','');">2012</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2011','05','');">2011</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2010','05','');">2010</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2009','05','');">2009</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2008','05','');">2008</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2007','05','');">2007</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2006','05','');">2006</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2005','05','');">2005</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2004','05','');">2004</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2003','05','');">2003</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2002','05','');">2002</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2001','05','');">2001</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2000','05','');">2000</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('1999','05','');">1999</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('1998','05','');">1998</button>
          </li>
        
          <li class="list" role="presentation">
            <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('1997','05','');">1997</button>
          </li>
    ...
    <div class="select_box">
      ...
      <ul class="option_list" role="listbox" id="_monthList">
        ...
        <!-- [D] 비활성회 되어야 하는 button.btn_date 에 disabled 속성을 추가 해 주세요. -->
              ...
              <li class="list" role="presentation">
                <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','01','');">01</button>
              </li>
            
              <li class="list" role="presentation">
                <button class="btn_option" type="button" role="option" aria-selected="false" onclick="changeSchedule('2023','02','');">02</button>
              </li>
              ...
              <li class="list" role="presentation">
                <button class="btn_option" type="button" role="option" aria-selected="true" onclick="changeSchedule('2023','05','');">05</button>
              </li>
    ...
    <button class="btn_move_date prev" type="button" onclick="clickcr(this, 'sch.prevmonth', '', '', event);changeSchedule('2023','04','');">
      <span class="blind">이전 달로 이동</span></button>
    <button class="btn_move_date next" type="button" disabled="" onclick="clickcr(this, 'sch.nextmonth', '', '', event);changeSchedule('2023','05','');">
      <span class="blind">다음 달로 이동</span></button>
  </div>
...
<div class="sch_tb_top">
  <table cellspacing="0" border="1">
    ...
    <tr>
      ...
      <th scope="col"><span>중계</span></th>
      <th scope="col"><span>중계 방송사</span></th>
      <th scope="col"><span>장소</span></th>
    </tr>
    </thead>
  </table>
</div>
        ...
        <table cellspacing="0" border="1">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td rowspan="1"><span class="td_date"><strong>5.1</strong> (월)</span></td>
              
              <td><span class="td_hour">19:00</span></td>
              <td><span class="team_lft">서울 SK</span>
                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbl/41/55.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);" width="25" height="25" alt="서울 SK" title="서울 SK"></span>
                    ...
                    <strong class="td_score">100<em>:</em>91
                    </strong>
                ...
                <span class="team_rgt">안양 KGC</span>
              </td>
              <td>
                                <span class="td_btn">
                  
                    
                      <a href="/game/20230501557041044/relay"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_wd.gif" width="61" height="23" alt="문자중계"></a>
                      ...
                      <a href="/game/20230501557041044/record"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_rcd.gif" width="61" height="23" alt="경기기록"></a>
                        ...
                        <a href="https://m.sports.naver.com/basketball/video?category=kbl&amp;gameId=20230501557041044&amp;tab=game&amp;date=2023-05-01&amp;sort=date" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_vod.gif"></a>
              ...
              <td>
                <span class="td_stadium">잠실학생체육관</span>
              </td>
            </tr>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.2</strong> (화)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
        </table>
      </div>
        ...
        <table cellspacing="0" border="1">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td rowspan="1"><span class="td_date"><strong>5.3</strong> (수)</span></td>
              ...
              <td><span class="team_lft">서울 SK</span>
                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbl/41/55.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);" width="25" height="25" alt="서울 SK" title="서울 SK"></span>
                    ...
                    <strong class="td_score">66<em>:</em>60
                    </strong>
              ...
              <td>
                      ...
                      <a href="/game/20230503557041045/relay"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_wd.gif" width="61" height="23" alt="문자중계"></a>
                      ...
                      <a href="/game/20230503557041045/record"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_rcd.gif" width="61" height="23" alt="경기기록"></a>
                        ...
                        <a href="https://m.sports.naver.com/basketball/video?category=kbl&amp;gameId=20230503557041045&amp;tab=game&amp;date=2023-05-03&amp;sort=date" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_vod.gif"></a>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.4</strong> (목)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
        ...
        <table cellspacing="0" border="1">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td rowspan="1"><span class="td_date"><strong>5.5</strong> (금)</span></td>
              
              <td><span class="td_hour">18:00</span></td>
              <td><span class="team_lft">안양 KGC</span>
                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbl/41/70.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);" width="25" height="25" alt="안양 KGC" title="안양 KGC"></span>
                
                  
                  
                    <strong class="td_score">86<em>:</em>77
                    </strong>
                  
                
                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbl/41/55.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);" width="25" height="25" alt="서울 SK" title="서울 SK"></span>
                <span class="team_rgt">서울 SK</span>
              </td>
              <td>
                                <span class="td_btn">
                  
                    
                      <a href="/game/20230505705541046/relay"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_wd.gif" width="61" height="23" alt="문자중계"></a>
                      ...
                      <a href="/game/20230505705541046/record"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_rcd.gif" width="61" height="23" alt="경기기록"></a>
                        ...
                        <a href="https://m.sports.naver.com/basketball/video?category=kbl&amp;gameId=20230505705541046&amp;tab=game&amp;date=2023-05-05&amp;sort=date" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_vod.gif"></a>
              ...
              <td>
                <span class="td_stadium">안양실내체육관</span>
              </td>
            </tr>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.6</strong> (토)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
        ...
        <table cellspacing="0" border="1">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td rowspan="1"><span class="td_date"><strong>5.7</strong> (일)</span></td>
              ...
              <td><span class="team_lft">안양 KGC</span>
                <span class="emblem"><img src="https://dthumb-phinf.pstatic.net/?src=https://sports-phinf.pstatic.net/team/kbl/41/70.png&amp;type=f25_25&amp;refresh=1" onerror="imageOnError(this);" width="25" height="25" alt="안양 KGC" title="안양 KGC"></span>
                    ...
                    <strong class="td_score">100<em>:</em>97
                    </strong>
              ...
              <td>
                      ...
                      <a href="/game/20230507705541047/relay"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_wd.gif" width="61" height="23" alt="문자중계"></a>
                      ...
                      <a href="/game/20230507705541047/record"><img src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_rcd.gif" width="61" height="23" alt="경기기록"></a>
                        ...
                        <a href="https://m.sports.naver.com/basketball/video?category=kbl&amp;gameId=20230507705541047&amp;tab=game&amp;date=2023-05-07&amp;sort=date" onclick="clickcr(this, 'sch.gamevod', '', '', event);"><img width="61" height="23" alt="경기영상" src="https://imgsports.pstatic.net/images/section/volleyball/css/btn_vod.gif"></a>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.8</strong> (월)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.9</strong> (화)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.10</strong> (수)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.11</strong> (목)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.12</strong> (금)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.13</strong> (토)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.14</strong> (일)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.15</strong> (월)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.16</strong> (화)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.17</strong> (수)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.18</strong> (목)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.19</strong> (금)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.20</strong> (토)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.21</strong> (일)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.22</strong> (월)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb nogame ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.23</strong> (화)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
      ...
      <div class="sch_tb2 nogame2 ">
        <table cellspacing="0" border="1">
          ...
          <tbody>
          <tr>
            <td rowspan="5"><span class="td_date"><strong>5.24</strong> (수)</span></td>
            <td><span class="td_hour">-</span></td>
            <td><span class="td_none">남자 프로농구 경기가 없습니다.</span></td>
          </tr>
          </tbody>
