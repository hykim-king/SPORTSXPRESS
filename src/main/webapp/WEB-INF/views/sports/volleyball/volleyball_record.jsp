...
<nav class="sports_lnb_sub">
  ...
  <li class="lnb_sub_item " role="presentation">
    <a href="/ehr/sportsxpress/volleyball_record.do" class="link_lnb_sub" role="menuitem" onclick="clickcr(this, 'LNB.record', 'record', '', event); " aria-current="page">
...
<div class="date_select_nav type_season">
  ...
  <div class="now_date_area">
    ...
    <ul class="round_choice ">
        <li><a href="/volleyball/record/index?category=kovo&amp;year=2022">남자부</a></li>
        <li><a href="/volleyball/record/index?category=wkovo&amp;year=2022">여자부</a></li>
    </ul>
</div>
<div class="tbl_box">
<table cellspacing="0" cellpadding="0">
<caption>선수기록순위 테이블</caption>
...
<thead>
    <tr>
        ...
        <th><div class="gpnt"><a href="javaScript:sortByColumn('regularTeamRecordList','winPoint');"><strong id="regularTeamRecordList_winPoint" class="sort"><span class="blind">승점</span></strong></a></div></th>
        <th><div class="wpnt"><a href="javaScript:sortByColumn('regularTeamRecordList','won');"><strong id="regularTeamRecordList_won"><span class="blind">승</span></strong></a></div></th>
        <th><div class="lpnt"><a href="javaScript:sortByColumn('regularTeamRecordList','lost');"><strong id="regularTeamRecordList_lost"><span class="blind">패</span></strong></a></div></th>
        <th><div class="set_g"><a href="javaScript:sortByColumn('regularTeamRecordList','setWinLostRate');"><strong id="regularTeamRecordList_setWinLostRate"><span class="blind">세트득실률</span></strong></a></div></th>
        <th><div class="scr_g"><a href="javaScript:sortByColumn('regularTeamRecordList','pointRate');"><strong id="regularTeamRecordList_pointRate"><span class="blind">점수득실률</span></strong></a></div></th>
        <th><div class="set"><a href="javaScript:sortByColumn('regularTeamRecordList','setCount');"><strong id="regularTeamRecordList_setCount"><span class="blind">세트수</span></strong></a></div></th>
        <th><div class="atck"><a href="javaScript:sortByColumn('regularTeamRecordList','attackSuccessRate');"><strong id="regularTeamRecordList_attackSuccessRate"><span class="blind">공격성공률</span></strong></a></div></th>
        <th><div class="blck"><a href="javaScript:sortByColumn('regularTeamRecordList','blockingAverage');"><strong id="regularTeamRecordList_blockingAverage"><span class="blind">블로킹(세트당)</span></strong></a></div></th>
        <th><div class="srve"><a href="javaScript:sortByColumn('regularTeamRecordList','servesAverage');"><strong id="regularTeamRecordList_servesAverage"><span class="blind">서브(세트당)</span></strong></a></div></th>
        <th><div class="score"><a href="javaScript:sortByColumn('regularTeamRecordList','point');"><strong id="regularTeamRecordList_point"><span class="blind">득점</span></strong></a></div></th>
    </tr>
</thead>
<tbody id="regularTeamRecordList_table">
    ...
    <tr class="on">
        ...
        <td class="score"><span>3176</span></td>
    </tr>
    ...
    <tr class="on">
        ...
        <td><span>134</span></td>
        <td><span>51.47</span></td>
        <td><span>2.90</span></td>
        <td><span>1.45</span></td>
        <td class="score"><span>3111</span></td>
    </tr>
    ...
    <tr class="on">
        ...
        <td><span>144</span></td>
        <td><span>51.27</span></td>
        <td><span>2.31</span></td>
        <td><span>1.43</span></td>
        <td class="score"><span>3224</span></td>
    </tr>
    ...
    <tr class="on">
        ...
        <td><span>149</span></td>
        <td><span>52.30</span></td>
        <td><span>2.50</span></td>
        <td><span>1.37</span></td>
        <td class="score"><span>3306</span></td>
    </tr>
    ...
    <tr>
        ...
        <td><span>16</span></td>
        <td><span>20</span></td>
        <td><span>0.838</span></td>
        <td><span>0.954</span></td>
        <td><span>136</span></td>
        <td><span>50.69</span></td>
        <td><span>2.07</span></td>
        <td><span>1.47</span></td>
        <td class="score"><span>2953</span></td>
    </tr>
    ...
    <tr>
        ...
        <td><span>15</span></td>
        <td><span>21</span></td>
        <td><span>0.734</span></td>
        <td><span>0.946</span></td>
        <td><span>137</span></td>
        <td><span>50.87</span></td>
        <td><span>1.98</span></td>
        <td><span>1.01</span></td>
        <td class="score"><span>3037</span></td>
    </tr>
    ...
    <tr>
        ...
        <td><span>11</span></td>
        <td><span>25</span></td>
        <td><span>0.671</span></td>
        <td><span>0.952</span></td>
        <td><span>142</span></td>
        <td><span>49.22</span></td>
        <td><span>1.81</span></td>
        <td><span>1.21</span></td>
        <td class="score"><span>3050</span></td>
    </tr>
...
<div class="tbl_box type2">
    <table cellspacing="0" cellpadding="0">
        <thead>
            <tr><th><div class="rank"><strong><span class="blind">순위</span></strong></div></th>
            <th><div class="player"><strong><span class="blind">선수</span></strong></div></th>
            <th><div class="score"><a href="javaScript:sortByPlayerColumn('PO');"><strong id="player_PO" class="sort"><span class="blind">득점</span></strong></a></div></th>
            <th><div class="atck2"><a href="javaScript:sortByPlayerColumn('A');"><strong id="player_A"><span class="blind">공격성공률</span></strong></a></div></th>
            <th><div class="srve"><a href="javaScript:sortByPlayerColumn('V');"><strong id="player_V"><span class="blind">서브</span></strong></a></div></th>
            <th><div class="blck2"><a href="javaScript:sortByPlayerColumn('BB');"><strong id="player_BB"><span class="blind">블로킹(세트당)</span></strong></a></div></th>
            <th><div class="dfnd"><a href="javaScript:sortByPlayerColumn('RD');"><strong id="player_RD"><span class="blind">수비(세트당)</span></strong></a></div></th>
            <th><div class="set2"><a href="javaScript:sortByPlayerColumn('SS');"><strong id="player_SS"><span class="blind">세트(세트당)</span></strong></a></div></th>
...
<div class="record_info">
    ...
    <ul class="p_noti">
                ...
                <li>※ 배구 순위는 시즌 종료 시 전년도 순위 기준으로 노출되며, 개막일 이후 새 시즌 순위표로 노출됩니다.</li>
