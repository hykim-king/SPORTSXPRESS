...
<meta property="og:url"
	content="https://sports.news.naver.com/wfootball/schedule/index.nhn">
...
<link rel="stylesheet" type="text/css"
	href="https://ssl.pstatic.net/static.sports/resources/pc/8088/66/88/664600/css/generated/nsportsCss.css">
...
<script type="text/javascript" id="undefined"
	src="https://ssl.pstatic.net/static.sports/resources/pc/8088/66/88/664600/js/generated/baseJsBottomLazy.js"></script>
...
<body>
	<!-- 사이드 광고 -->
	<div id="veta_skin_left" data-veta-preview="p_sports_dpl"
		style="display: none;"></div>
	<div id="veta_skin_right" data-veta-preview="p_sports_dpl"
		style="display: none;"></div>

	<div id="u_skip">
		<a href="#lnb_main_sub"
			onclick="document.getElementById('lnb_main_sub').tabIndex=-1;document.getElementById('lnb_main_sub').focus();"><span>메인
				메뉴로 바로가기</span></a>
		<div id="lnb_menu_link"></div>
		<div id="container_link">
			<a href="#container"
				onclick="document.getElementById('container').tabIndex=-1;document.getElementById('container').focus();"><span>본문으로
					바로가기</span></a>
		</div>
	</div>
	...
	<div id="wrap">
		...
		<header id="header" class="sports_header_pc type_wfootball">
			<div class="sports_gnb" role="banner">
				...
				<div class="sub_logo_area">
					<a href="https://m.sports.naver.com/community/index"
				...
				<div class="service_area">
					<a href="https://news.naver.com/"
						onclick="clickcr(this, 'STA.news', '', '', event);"
						class="logo_news"><span class="blind">뉴스</span></a> <a
						href="https://weather.naver.com/"
						onclick="clickcr(this, 'STA.whether', '', '', event);"
						class="logo_weather"><span class="blind">날씨</span></a> <a
						href="https://entertain.naver.com/"
						onclick="clickcr(this, 'STA.entertain', '', '', event);"
					...
					<div class="gnb_one" id="gnb">
						...
						<ul class="gnb_lst" id="gnb_lst" style="display: block;">
							<li class="gnb_login_li" id="gnb_login_layer"
								...
								href="https://nid.naver.com/nidlogin.login?url=https%3A%2F%2Fsports.news.naver.com%2Fwfootball%2Fschedule%2Findex"
							...
							<li class="gnb_my_li" id="gnb_my_layer" style="display: none"><div
								...
								<div class="gnb_my_lyr" id="gnb_my_lyr">
										...
										<div class="gnb_txt_area">
											<p class="gnb_account">
												<span class="gnb_name" id="gnb_name2"><a
													...
													class="gnb_btn_login"
													href="https://nid.naver.com/nidlogin.logout?returl=https%3A%2F%2Fsports.news.naver.com%2Fwfootball%2Fschedule%2Findex"
									...
									<div class="gnb_my_community">
										<a href="https://blog.naver.com/MyBlog.naver" class="gnb_blog">내
											블로그</a><a href="https://section.cafe.naver.com" class="gnb_cafe">가입한
											카페</a><a href="https://pay.naver.com" class="gnb_pay"
											id="gnb_pay_banner_membership" style="display: block;"><span>N
												Pay</span></a><a href="https://nid.naver.com/membership/join"
											class="gnb_pay" id="gnb_pay_banner_newbie"
											style="display: none;"><i>네이버 멤버십 최대 5% 적립</i></a>
									</div>
			...
			<nav class="sports_lnb" role="navigation" id="_sports_lnb_menu">
				...
				<ul id="lnb_list" class="lnb_list" role="menubar">
					...
					<li class="lnb_item" role="presentation"><a
						...
						onclick="clickcr(this, 'LNB.worldfootball', 'worldfootball', '', event); ; ">축구</a>
					</li>
			...
			<nav class="sports_lnb_sub">
				<ul id="lnb_sub_list" class="lnb_sub_list" role="menubar">
					...
					<li class="lnb_sub_item " role="presentation"><a
						href="/ehr/sportsxpress/football_news.do" class="link_lnb_sub"
						role="menuitem"
						onclick="clickcr(this, 'LNB.news', 'news', '', event); "> <span
							class="menu">최신뉴스</span>
					</a></li>
					<li class="lnb_sub_item " role="presentation"><a
						href="/ehr/sportsxpress/football_Schedule.do" class="link_lnb_sub"
						role="menuitem"
			...
			<script id="_sports_lnb_menu_li_template"
				type="text/x-handlebars-template">

</script>

			<script id="_sports_lnb_sub_menu_template"
				type="text/x-handlebars-template">
		...
		<div id="container">
			...
			<div id="content" class="schedule wfootball_schedule">
				<div class="tab_event">
					<ul class="list" id="_categoryList">
						...
						<li class="selected"><a href="#" data-category="epl"><span
								class="menu">프리미어리그</span></a></li>
				...
				<div class="schedule_week_area">
					<div class="schedule_week" id="_dateList">
						<ul class="list" role="tablist" aria-labelledby="daily-list">
							<li role="tab" class="selected" aria-selected="true"
								data-id="20230529"><a href="#"
								onclick="scoreboardClickCode(this, event)"> <span
									class="day">05.29</span> <span class="week">(월)</span>

							</a></li>
							<li role="tab" data-id="20230530"><span class="disabled">
									<span class="day">05.30</span> <span class="week">(화)</span>

							</span></li>
							<li role="tab" data-id="20230531"><span class="disabled">
									<span class="day">05.31</span> <span class="week">(수)</span>

							</span></li>
							<li role="tab" data-id="20230601"><span class="disabled">
									<span class="day">06.01</span> <span class="week">(목)</span>

							</span></li>
							<li role="tab" data-id="20230602"><span class="disabled">
									<span class="day">06.02</span> <span class="week">(금)</span>

							</span></li>
							<li role="tab" data-id="20230603"><span class="disabled">
									<span class="day">06.03</span> <span class="week">(토)</span>

							</span></li>
							<li role="tab" data-id="20230604"><span class="disabled">
									<span class="day">06.04</span> <span class="week">(일)</span>

							</span></li>
						</ul>
						<!-- 활성화시 a, 비활성화시 span -->
						<a href="#" class="arr prev" data-id="20230526"
							onclick="clickcr(this, 'sch*a.datemore', '', '', event);"><span>이전</span></a>
						...
						<div class="list">
								...
								<div class="vs_area">
									<div class="emblem">
										<img
											...
											width="64" height="64" alt="사우샘프턴"
											onerror="imageOnError(this);">
									</div>
									<span class="team">${matches[0].hname}</span> <strong
										class="num">${matches[0].hscore}</strong>
								</div>
								<div class="vs_area">
									<div class="emblem">
										<img
											src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/9.png&amp;type=f64_64"
											width="64" height="64" alt="리버풀"
											onerror="imageOnError(this);">
									</div>
									<span class="team">${matches[0].ateam}</span> <strong
										class="num">${matches[0].ascore}</strong>
								</div>



								<div class="vs_btn">
									<a href="/game/2023052910034152443/record" class="btn"
										onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
								</div>
							...
							<div class="bx end">
								...
								<div class="vs_area">
									<div class="emblem">
										<img
											src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/12.png&amp;type=f64_64"
											width="64" height="64" alt="맨유" onerror="imageOnError(this);">
									</div>
									<span class="team">${matches[1].hname}</span> <strong
										class="num">${matches[1].hscore}</strong>
								</div>
								<div class="vs_area">
									<div class="emblem">
										<img
											src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/55.png&amp;type=f64_64"
											width="64" height="64" alt="풀럼" onerror="imageOnError(this);">
									</div>
									<span class="team">${matches[1].ateam}</span> <strong
										class="num">${matches[1].ascore}</strong>
								</div>



								<div class="vs_btn">
									<a href="/game/2023052910034152441/record" class="btn"
										onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
								</div>
							...
							<div class="bx end">
								...
								<div class="vs_area">
									<div class="emblem">
										<img
											src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/29.png&amp;type=f64_64"
											width="64" height="64" alt="레스터"
											onerror="imageOnError(this);">
									</div>
									<span class="team">${matches[2].hname}</span> <strong
										class="num">${matches[2].hscore}</strong>
								</div>
								<div class="vs_area">
									<div class="emblem">
										<img
											src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/43.png&amp;type=f64_64"
											width="64" height="64" alt="웨스트햄"
											onerror="imageOnError(this);">
									</div>
									<span class="team">${matches[2].ateam}</span> <strong
										class="num">${matches[2].ascore}</strong>
								</div>



								<div class="vs_btn">
									<a href="/game/2023052910034152439/record" class="btn"
										onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
								</div>

							</div>
						</div>
						<span class="arr prev"><span>이전</span></span> <a href="#"
							class="arr next"><span>다음</span></a>
					</div>
					<div class="schedule_paginate" role="navigation"
						aria-labelledby="schedule paging" id="_pageList">
						<span aria-selected="true" data-page="1" class="selected">1페이지</span>
						<span aria-selected="false" data-page="2">2페이지</span> <span
							aria-selected="false" data-page="3">3페이지</span> <span
							aria-selected="false" data-page="4">4페이지</span>
					</div>
				...
				<div class="schedule_month_area">
					...
					<div class="schedule_subtitle" id="_seasonTitle">
						<h4>
							<span class="_seasonTitle">2022/23시즌</span> 일정/결과
						</h4>
					</div>
					<!-- 스포츠 공통 콤보 박스 -->

					<div class="combo_box align_right" id="__subscribe">
						<a href="#" class="btn_rss" id="_btnRss" data-category="epl"
							onclick="clickcr(this, 'sch.feed', '', '', event);"><span>+구독</span></a>
					</div>
					...
					<div class="date_select_nav type_season">
						...
						<div class="select_box_area type_date" id="_seasonListArea">
							<div class="select_box">
								<button class="btn_toggle" type="button" aria-haspopup="listbox"
									aria-expanded="false" aria-label="연도 선택">
								...
								<ul class="option_list" role="listbox" id="_seasonOptionList">
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="true" data-year="2022">2022-23</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2021">2021-22</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2020">2020-21</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2019">2019-20</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2018">2018-19</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2017">2017-18</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2016">2016-17</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2015">2015-16</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2014">2014-15</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2013">2013-14</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2012">2012-13</button>
									</li>
									<li class="list" role="presentation">
										<button class="btn_option" type="button" role="option"
											aria-selected="false" data-year="2011">2011-12</button>
									</li>
								</ul>
							</div>
							...
							<button class="btn_move_date next" type="button" disabled=""
								data-year="">
								<span class="blind">다음 달로 이동</span>
							</button>
						</div>
						<div class="now_date_area">
							<button class="btn_now_date" type="button" id="_currentDate">
								현재<span class="blind">날짜로 이동</span>
							</button>
						</div>
					</div>
					...
					<div class="schedule_month">
						<ul class="list" role="tablist" aria-labelledby="month-list"
							id="_monthList">
							<li role="tab" data-yearmonth="202208"><a href="#"
								class="_month_list_btn"> <span class="year">2022년</span> <span
									class="month">8월</span>
							</a></li>
							<li role="tab" data-yearmonth="202209"><a href="#"
								class="_month_list_btn"> <span class="month">9월</span>
							</a></li>
							<li role="tab" data-yearmonth="202210"><a href="#"
								class="_month_list_btn"> <span class="month">10월</span>
							</a></li>
							<li role="tab" data-yearmonth="202211"><a href="#"
								class="_month_list_btn"> <span class="month">11월</span>
							</a></li>
							<li role="tab" data-yearmonth="202212"><a href="#"
								class="_month_list_btn"> <span class="month">12월</span>
							</a></li>
							<li role="tab" data-yearmonth="202301"><a href="#"
								class="_month_list_btn"> <span class="year">2023년</span> <span
									class="month">1월</span>
							</a></li>
							<li role="tab" data-yearmonth="202302"><a href="#"
								class="_month_list_btn"> <span class="month">2월</span>
							</a></li>
							<li role="tab" data-yearmonth="202303"><a href="#"
								class="_month_list_btn"> <span class="month">3월</span>
							</a></li>
							<li role="tab" data-yearmonth="202304"><a href="#"
								class="_month_list_btn"> <span class="month">4월</span>
							</a></li>
							<li role="tab" data-yearmonth="202305" aria-selected="true"
								class="selected"><a href="#" class="_month_list_btn"> <span
									class="month">5월</span>
							</a></li>
						</ul>
					</div>
						...
						<table summary="월간 일정/결과" cellspacing="0">
							...
							<tbody id="_monthlyScheduleList">
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span
												class="place">${matches[0].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/9.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[0].hname}</span> <span
												class="score">${matches[0].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/19.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[0].ateam}</span> <span
												class="score">${matches[0].ascore}</span>
											</span>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[1].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/29.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[1].hname}</span> <span
												class="score">${matches[1].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/8.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[1].ateam}</span> <span
												class="score">${matches[1].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050210034152357/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[2].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/1006.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[2].hname}</span> <span
												class="score">${matches[2].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/4.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[2].ateam}</span> <span
												class="score">${matches[2].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050310040620361/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[3].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[3].hname}</span> <span
												class="score">${matches[3].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/55.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[3].ateam}</span> <span
												class="score">${matches[3].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050410040274513/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[4].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/11.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[4].hname}</span> <span
												class="score">${matches[4].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/43.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[4].ateam}</span> <span
												class="score">${matches[4].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050410040274521/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[5].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/6795.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[5].hname}</span> <span
												class="score">${matches[5].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/12.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[5].ateam}</span> <span
												class="score">${matches[5].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050510040274505/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[6].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/23.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[6].hname}</span> <span
												class="score">${matches[6].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/4.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[6].ateam}</span> <span
												class="score">${matches[6].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050610034152365/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[7].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[7].hname}</span> <span
												class="score">${matches[7].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/28.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[7].ateam}</span> <span
												class="score">${matches[7].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050610034152373/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[8].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[8].hname}</span> <span
												class="score">${matches[8].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/5.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[8].ateam}</span> <span
												class="score">${matches[8].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050610034152379/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[9].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/44.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[9].hname}</span> <span
												class="score">${matches[9].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/2.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[9].ateam}</span> <span
												class="score">${matches[9].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050610034152383/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">01:30</span> <span class="place">${matches[10].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[10].hname}</span> <span
												class="score">${matches[10].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/48.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[10].ateam}</span> <span
												class="score">${matches[10].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050710034152371/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[11].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/31.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[11].hname}</span> <span
												class="score">${matches[11].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/1006.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[11].ateam}</span> <span
												class="score">${matches[11].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050810034152375/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">03:00</span> <span class="place">${matches[12].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[12].hname}</span> <span
												class="score">${matches[12].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/12.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[12].ateam}</span> <span
												class="score">${matches[12].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050810034152381/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[13].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[13].hname}</span> <span
												class="score">${matches[13].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/29.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[13].ateam}</span> <span
												class="score">${matches[13].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050810034152369/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">01:30</span> <span class="place">${matches[14].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[14].hname}</span> <span
												class="score">${matches[14].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/8.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[14].ateam}</span> <span
												class="score">${matches[14].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050910040265287/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[15].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/15.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[15].hname}</span> <span
												class="score">${matches[15].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/18.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[15].ateam}</span> <span
												class="score">${matches[15].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023050910034152377/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">20:30</span> <span class="place">${matches[16].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[16].hname}</span> <span
												class="score">${matches[16].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/31.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[16].ateam}</span> <span
												class="score">${matches[16].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051310034152397/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[17].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[17].hname}</span> <span
												class="score">${matches[17].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/19.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[17].ateam}</span> <span
												class="score">${matches[17].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051310034152387/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[18].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[18].hname}</span> <span
												class="score">${matches[18].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/15.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[18].ateam}</span> <span
												class="score">${matches[18].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051310034152391/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[19].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[19].hname}</span> <span
												class="score">${matches[19].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/23.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[19].ateam}</span> <span
												class="score">${matches[19].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051310034152393/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[20].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[20].hname}</span> <span
												class="score">${matches[20].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/44.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[20].ateam}</span> <span
												class="score">${matches[20].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051310034152401/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[21].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[21].hname}</span> <span
												class="score">${matches[21].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/55.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[21].ateam}</span> <span
												class="score">${matches[21].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051310034152403/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">22:00</span> <span class="place">${matches[22].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[22].hname}</span> <span
												class="score">${matches[22].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/43.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[22].ateam}</span> <span
												class="score">${matches[22].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051410034152389/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">22:00</span> <span class="place">${matches[23].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[23].hname}</span> <span
												class="score">${matches[23].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/11.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[23].ateam}</span> <span
												class="score">${matches[23].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051410034152395/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[24].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[24].hname}</span> <span
												class="score">${matches[24].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/6795.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[24].ateam}</span> <span
												class="score">${matches[24].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051510034152385/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[25].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[25].hname}</span> <span
												class="score">${matches[25].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/9.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[25].ateam}</span> <span
												class="score">${matches[25].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051610040531401/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">03:30</span> <span class="place">${matches[26].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[26].hname}</span> <span
												class="score">${matches[26].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/6795.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[26].ateam}</span> <span
												class="score">${matches[26].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023051910040795213/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">20:30</span> <span class="place">${matches[27].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[27].hname}</span> <span
												class="score">${matches[27].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/48.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[27].ateam}</span> <span
												class="score">${matches[27].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052010034152419/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[28].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[28].hname}</span> <span
												class="score">${matches[28].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/12.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[28].ateam}</span> <span
												class="score">${matches[28].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052010034152405/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[29].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[29].hname}</span> <span
												class="score">${matches[29].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/5.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[29].ateam}</span> <span
												class="score">${matches[29].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052010034152409/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[30].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[30].hname}</span> <span
												class="score">${matches[30].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/2.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[30].ateam}</span> <span
												class="score">${matches[30].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052010034152411/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">23:00</span> <span class="place">${matches[31].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[31].hname}</span> <span
												class="score">${matches[31].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/8.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[31].ateam}</span> <span
												class="score">${matches[31].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052010034152423/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">01:30</span> <span class="place">${matches[32].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[32].hname}</span> <span
												class="score">${matches[32].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/1006.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[32].ateam}</span> <span
												class="score">${matches[32].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052110034152417/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">21:30</span> <span class="place">${matches[33].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[33].hname}</span> <span
												class="score">${matches[33].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/28.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[33].ateam}</span> <span
												class="score">${matches[33].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052110034152421/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">22:00</span> <span class="place">${matches[34].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[34].hname}</span> <span
												class="score">${matches[34].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/18.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[34].ateam}</span> <span
												class="score">${matches[34].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052110034152407/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">00:00</span> <span class="place">${matches[35].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[35].hname}</span> <span
												class="score">${matches[35].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/4.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[35].ateam}</span> <span
												class="score">${matches[35].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052210034152413/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[36].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[36].hname}</span> <span
												class="score">${matches[36].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/29.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[36].ateam}</span> <span
												class="score">${matches[36].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052310040795215/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[37].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[37].hname}</span> <span
												class="score">${matches[37].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/11.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[37].ateam}</span> <span
												class="score">${matches[37].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052510040821741/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">04:00</span> <span class="place">${matches[38].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[38].hname}</span> <span
												class="score">${matches[38].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/4.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[38].ateam}</span> <span
												class="score">${matches[38].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052610040821743/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr class="division">
									...
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[39].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[39].hname}</span> <span
												class="score">${matches[39].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/44.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[39].ateam}</span> <span
												class="score">${matches[39].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052910034152425/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[40].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[40].hname}</span> <span
												class="score">${matches[40].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/6795.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[40].ateam}</span> <span
												class="score">${matches[40].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052910034152427/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[41].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[41].hname}</span> <span
												class="score">${matches[41].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/11.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[41].ateam}</span> <span
												class="score">${matches[41].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052910034152429/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[42].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[42].hname}</span> <span
												class="score">${matches[42].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/31.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[42].ateam}</span> <span
												class="score">${matches[42].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052910034152431/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[43].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[43].hname}</span> <span
												class="score">${matches[43].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/15.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[43].ateam}</span> <span
												class="score">${matches[43].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052910034152433/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[44].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[44].hname}</span> <span
												class="score">${matches[44].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/23.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[44].ateam}</span> <span
												class="score">${matches[44].ascore}</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052910034152435/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
										</div>
									</td>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[45].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[45].hname}</span> <span
												class="score">${matches[45].hscore}</span>
											</span> <span class="team_right winner"> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/19.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[45].ateam}</span> <span
												class="score">${matches[45].ascore}</span> <span class="win">승리팀</span>
											</span>
									...
									<td class="broadcast">
										<div class="inner">
											<a href="/game/2023052910034152437/record" class="btn"
												onclick="clickcr(this, 'sch*b.eplwar', '', '', event);">경기기록</a>
											<a
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[46].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[46].hname}</span> <span
												class="score">${matches[46].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/43.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[46].ateam}</span> <span
												class="score">${matches[46].ascore}</span>
											</span>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[47].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left winner"> <span class="emblem"><img
												...
												<span class="name">${matches[47].hname}</span> <span
												class="score">${matches[47].hscore}</span> <span class="win">승리팀</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/55.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[47].ateam}</span> <span
												class="score">${matches[47].ascore}</span>
											</span>
								...
								<tr>
									<td class="time_place">
										<div class="inner">
											<span class="time">00:30</span> <span class="place">${matches[48].location}</span>
										</div>
									</td>
									<td>
										<div class="inner ">
											...
											<span class="team_left "> <span class="emblem"><img
												...
												<span class="name">${matches[48].hname}</span> <span
												class="score">${matches[48].hscore}</span>
											</span> <span class="team_right "> <span class="emblem"><img
													src="https://dthumb-phinf.pstatic.net?src=https://sports-phinf.pstatic.net/team/wfootball/default/9.png&amp;type=f25_25"
													width="25" height="25" onerror="imageOnError(this);"></span>


												<span class="name">${matches[48].ateam}</span> <span
												class="score">${matches[48].ascore}</span>
											</span>
				...
				<div class="schedule_info">
					네이버 스포츠에서 제공하는 일정, 결과, 기록 등의 데이터는 '제공처'의 사정에 따라 지연되거나 잘못 표시될 수
					있습니다.<br> 네이버(주)는 그에 따른 스포츠 데이터의 정확성 및 신뢰성을 담보하지 않습니다. 궁금하신
					사항은 <a
						href="https://help.naver.com/support/alias/contents2/sports/sports_5.naver"
						target="_blank" class="link">고객센터</a>를 통해서 문의해주시기 바랍니다.
				</div>
			...
			<script id="_scoreboardListTemplate"
				type="text/x-handlebars-template">
			...
			<script id="_monthlyScheduleListTemplate"
				type="text/x-handlebars-template">
			...
			<script id="_tournamentNavTabTemplate"
				type="text/x-handlebars-template">
			...
			<script id="_groupRankingListTemplate"
				type="text/x-handlebars-template">

</script>

			<script id="_tournamentBracketTemplate"
				type="text/x-handlebars-template">
			...
			<script id="_wfootballSeasonListTemplate"
				type="text/x-handlebars-template">
