...
public class Basketball_InfoVO extends DTO {
	...
	public Basketball_InfoVO() {

	}


	public Basketball_InfoVO(int basketid, String lname, String name, String profile, int played, int score,
